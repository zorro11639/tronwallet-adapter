...
export function TronLinkAdapterDemo() {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 900 }}>
      ...
      <Select labelId="demo-simple-select-label" id="demo-simple-select" value={selectedChainId} label="Chain" size="small" onChange={(e) => setSelectedChainId(e.target.value)}>
