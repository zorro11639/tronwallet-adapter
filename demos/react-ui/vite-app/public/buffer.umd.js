(function (k, _) {
    typeof exports == 'object' && typeof module < 'u'
        ...
        ? define(_)
        : ((k = typeof globalThis < 'u' ? globalThis : k || self), (k.Buffer = _()));
})(this, function () {
    'use strict';
    var k = {},
        _ = {};
    (_.byteLength = pr), (_.toByteArray = lr), (_.fromByteArray = wr);
    for (
        var R = [],
            T = [],
    ...
    function lr(p) {
        ...
        for (B = 0; B < o; B += 4)
            (f =
                (T[p.charCodeAt(B)] << 18) |
                (T[p.charCodeAt(B + 1)] << 12) |
                (T[p.charCodeAt(B + 2)] << 6) |
                T[p.charCodeAt(B + 3)]),
                (a[c++] = (f >> 16) & 255),
                (a[c++] = (f >> 8) & 255),
                (a[c++] = f & 255);
        return (
            y === 2 && ((f = (T[p.charCodeAt(B)] << 2) | (T[p.charCodeAt(B + 1)] >> 4)), (a[c++] = f & 255)),
            y === 1 &&
                ((f = (T[p.charCodeAt(B)] << 10) | (T[p.charCodeAt(B + 1)] << 4) | (T[p.charCodeAt(B + 2)] >> 2)),
                (a[c++] = (f >> 8) & 255),
                (a[c++] = f & 255)),
            a
        );
    ...
    function yr(p, f, l) {
        for (var x, y = [], a = f; a < l; a += 3)
            (x = ((p[a] << 16) & 16711680) + ((p[a + 1] << 8) & 65280) + (p[a + 2] & 255)), y.push(ar(x));
        return y.join('');
    }
    function wr(p) {
        for (var f, l = p.length, x = l % 3, y = [], a = 16383, c = 0, o = l - x; c < o; c += a)
            y.push(yr(p, c, c + a > o ? o : c + a));
        return (
            x === 1
                ? ((f = p[l - 1]), y.push(R[f >> 2] + R[(f << 4) & 63] + '=='))
                : x === 2 &&
                  ((f = (p[l - 2] << 8) + p[l - 1]), y.push(R[f >> 10] + R[(f >> 4) & 63] + R[(f << 2) & 63] + '=')),
            y.join('')
        );
    }
    var j = {};
    /*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ (j.read = function (
        p,
        f,
        l,
        x,
        ...
        var a,
            ...
            L = l ? -1 : 1,
            A = p[f + F];
        for (F += L, a = A & ((1 << -I) - 1), A >>= -I, I += o; I > 0; a = a * 256 + p[f + F], F += L, I -= 8);
        for (c = a & ((1 << -I) - 1), a >>= -I, I += x; I > 0; c = c * 256 + p[f + F], F += L, I -= 8);
        if (a === 0) a = 1 - C;
        else {
            if (a === B) return c ? NaN : (A ? -1 : 1) * (1 / 0);
            (c = c + Math.pow(2, x)), (a = a - C);
        }
        return (A ? -1 : 1) * c * Math.pow(2, a - x);
    }),
        (j.write = function (p, f, l, x, y, a) {
            var c,
                o,
                B,
                C = a * 8 - y - 1,
                I = (1 << C) - 1,
                F = I >> 1,
                L = y === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0,
                A = x ? 0 : a - 1,
                P = x ? 1 : -1,
                O = f < 0 || (f === 0 && 1 / f < 0) ? 1 : 0;
            for (
                f = Math.abs(f),
                    isNaN(f) || f === 1 / 0
                        ...
                        : ((c = Math.floor(Math.log(f) / Math.LN2)),
                          f * (B = Math.pow(2, -c)) < 1 && (c--, (B *= 2)),
                          c + F >= 1 ? (f += L / B) : (f += L * Math.pow(2, 1 - F)),
                          f * B >= 2 && (c++, (B /= 2)),
                          c + F >= I
                              ? ((o = 0), (c = I))
                              : c + F >= 1
                              ? ((o = (f * B - 1) * Math.pow(2, y)), (c = c + F))
                              : ((o = f * Math.pow(2, F - 1) * Math.pow(2, y)), (c = 0)));
                y >= 8;
                p[l + A] = o & 255, A += P, o /= 256, y -= 8
            );
            for (c = (c << y) | o, C += y; C > 0; p[l + A] = c & 255, A += P, c /= 256, C -= 8);
            p[l + A - P] |= O * 128;
        });
    /*!
     ...
     */ return (
        (function (p) {
            const f = _,
                ...
                x =
                    typeof Symbol == 'function' && typeof Symbol.for == 'function'
                        ...
                        : null;
            (p.Buffer = o), (p.SlowBuffer = Br), (p.INSPECT_MAX_BYTES = 50);
            const y = 2147483647;
            (p.kMaxLength = y),
            ...
            function c(i) {
                if (i > y) throw new RangeError('The value "' + i + '" is invalid for option "size"');
            ...
            o.poolSize = 8192;
            function B(i, r, t) {
                if (typeof i == 'string') return L(i, r);
                ...
                if (
                    S(i, ArrayBuffer) ||
                    (i && S(i.buffer, ArrayBuffer)) ||
                    (typeof SharedArrayBuffer < 'u' &&
                        (S(i, SharedArrayBuffer) || (i && S(i.buffer, SharedArrayBuffer))))
                )
                    return O(i, r, t);
                if (typeof i == 'number')
            ...
            function I(i, r, t) {
                return (
                    C(i), i <= 0 ? c(i) : r !== void 0 ? (typeof t == 'string' ? c(i).fill(r, t) : c(i).fill(r)) : c(i)
                );
            }
            ...
            function A(i) {
                const r = i.length < 0 ? 0 : q(i.length) | 0,
                    t = c(r);
            ...
            function xr(i) {
                if (o.isBuffer(i)) {
                    const r = q(i.length) | 0,
                        t = c(r);
                    return t.length === 0 || i.copy(t, 0, 0, r), t;
                }
                if (i.length !== void 0) return typeof i.length != 'number' || X(i.length) ? c(0) : A(i);
                if (i.type === 'Buffer' && Array.isArray(i.data)) return A(i.data);
            }
            function q(i) {
                if (i >= y)
                    throw new RangeError(
                        'Attempt to allocate Buffer larger than maximum size: 0x' + y.toString(16) + ' bytes'
                    );
                return i | 0;
            }
            function Br(i) {
            ...
            (o.isBuffer = function (r) {
                ...
                (o.concat = function (r, t) {
                    ...
                    for (n = 0; n < r.length; ++n) {
                        ...
                        if (S(h, Uint8Array))
                            u + h.length > e.length
                                ? (o.isBuffer(h) || (h = o.from(h)), h.copy(e, u))
                                : Uint8Array.prototype.set.call(e, h, u);
            ...
            function z(i, r) {
                ...
                if (ArrayBuffer.isView(i) || S(i, ArrayBuffer)) return i.byteLength;
                if (typeof i != 'string')
                    throw new TypeError(
            ...
            (o.prototype.swap16 = function () {
                ...
                (o.prototype.toString = function () {
                    const r = this.length;
                    return r === 0 ? '' : arguments.length === 0 ? Q(this, 0, r) : Er.apply(this, arguments);
                }),
                ...
                x && (o.prototype[x] = o.prototype.inspect),
                (o.prototype.compare = function (r, t, n, e, u) {
                    ...
                    if (
                        ...
                        t < 0 || n > r.length || e < 0 || u > this.length)
                    )
            ...
            function Fr(i, r, t, n) {
                return Y(kr(r, i.length - t), i, t, n);
            }
                ...
                for (; e < t; ) {
                    ...
                    if (e + s <= t) {
                        ...
                        switch (s) {
                            ...
                            case 2:
                                (d = i[e + 1]),
                                    (d & 192) === 128 && ((w = ((u & 31) << 6) | (d & 63)), w > 127 && (h = w));
                                break;
                            case 3:
                                (d = i[e + 1]),
                                    (E = i[e + 2]),
                                    (d & 192) === 128 &&
                                        (E & 192) === 128 &&
                                        ((w = ((u & 15) << 12) | ((d & 63) << 6) | (E & 63)),
                                        w > 2047 && (w < 55296 || w > 57343) && (h = w));
                                break;
                            case 4:
                                (d = i[e + 1]),
                                    (E = i[e + 2]),
                                    ...
                                    (d & 192) === 128 &&
                                        (E & 192) === 128 &&
                                        (g & 192) === 128 &&
                                        ((w = ((u & 15) << 18) | ((d & 63) << 12) | ((E & 63) << 6) | (g & 63)),
                                        w > 65535 && w < 1114112 && (h = w));
                        }
                    }
                    h === null
                        ? ((h = 65533), (s = 1))
                        : h > 65535 && ((h -= 65536), n.push(((h >>> 10) & 1023) | 55296), (h = 56320 | (h & 1023))),
                        n.push(h),
                        (e += s);
                }
                return Ur(n);
            ...
            (o.prototype.readUintLE = o.prototype.readUIntLE =
                ...
                (o.prototype.readBigUInt64LE = N(function (r) {
                    (r = r >>> 0), $(r, 'offset');
                    const t = this[r],
                        n = this[r + 7];
                ...
                (o.prototype.readBigUInt64BE = N(function (r) {
                    (r = r >>> 0), $(r, 'offset');
                    const t = this[r],
                        n = this[r + 7];
                    (t === void 0 || n === void 0) && G(r, this.length - 8);
                ...
                (o.prototype.readBigInt64LE = N(function (r) {
                    (r = r >>> 0), $(r, 'offset');
                    const t = this[r],
                        n = this[r + 7];
                    (t === void 0 || n === void 0) && G(r, this.length - 8);
                ...
                (o.prototype.readBigInt64BE = N(function (r) {
                    (r = r >>> 0), $(r, 'offset');
                    const t = this[r],
                        n = this[r + 7];
                    (t === void 0 || n === void 0) && G(r, this.length - 8);
            ...
            function rr(i, r, t, n, e) {
                ...
                return (
                    (i[t++] = h), (h = h >> 8), (i[t++] = h), (h = h >> 8), (i[t++] = h), (h = h >> 8), (i[t++] = h), t
                );
            }
            ...
            (o.prototype.writeBigUInt64LE = N(function (r, t = 0) {
                return rr(this, r, t, BigInt(0), BigInt('0xffffffffffffffff'));
            })),
                (o.prototype.writeBigUInt64BE = N(function (r, t = 0) {
                ...
                (o.prototype.writeIntLE = function (r, t, n, e) {
                    ...
                    for (this[t] = r & 255; ++u < n && (h *= 256); )
                        r < 0 && s === 0 && this[t + u - 1] !== 0 && (s = 1),
                            (this[t + u] = (((r / h) >> 0) - s) & 255);
                    return t + n;
                }),
                ...
                (o.prototype.writeInt32LE = function (r, t, n) {
                    return (
                        (r = +r),
                        (t = t >>> 0),
                        n || U(this, r, t, 4, 2147483647, -2147483648),
                        (this[t] = r & 255),
                        (this[t + 1] = r >>> 8),
                        (this[t + 2] = r >>> 16),
                        (this[t + 3] = r >>> 24),
                ...
                (o.prototype.writeBigInt64LE = N(function (r, t = 0) {
                    return rr(this, r, t, -BigInt('0x8000000000000000'), BigInt('0x7fffffffffffffff'));
                })),
                (o.prototype.writeBigInt64BE = N(function (r, t = 0) {
            ...
            function nr(i, r, t, n, e) {
                return (r = +r), (t = t >>> 0), e || ir(i, r, t, 4), l.write(i, r, t, n, 23, 4), t + 4;
            }
            ...
            function er(i, r, t, n, e) {
                return (r = +r), (t = t >>> 0), e || ir(i, r, t, 8), l.write(i, r, t, n, 52, 8), t + 8;
            }
            (o.prototype.writeDoubleLE = function (r, t, n) {
                ...
                (o.prototype.fill = function (r, t, n, e) {
                    ...
                    if (typeof r == 'number') for (u = t; u < n; ++u) this[u] = r;
                        ...
                        const h = o.isBuffer(r) ? r : o.from(r, e),
                            s = h.length;
                    ...
                    function (i, r, t) {
                        ...
                        return (
                            Number.isInteger(t) && Math.abs(t) > 2 ** 32
                                ...
                                : typeof t == 'bigint' &&
                                  ((e = String(t)),
                                  (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (e = or(e)),
                                  (e += 'n')),
            ...
            function _r(i, r, t) {
                $(r, 'offset'), (i[r] === void 0 || i[r + t] === void 0) && G(r, i.length - (t + 1));
            }
            function ur(i, r, t, n, e, u) {
                if (i > t || i < r) {
                    ...
                    throw (
                        (u > 3
                            ? r === 0 || r === BigInt(0)
                                ? (s = `>= 0${h} and < 2${h} ** ${(u + 1) * 8}${h}`)
                                : (s = `>= -(2${h} ** ${(u + 1) * 8 - 1}${h}) and < 2 ** ${(u + 1) * 8 - 1}${h}`)
                            : (s = `>= ${r}${h} and <= ${t}${h}`),
                        new D.ERR_OUT_OF_RANGE('value', s, i))
                    );
                }
                _r(n, e, u);
            }
            function $(i, r) {
                if (typeof i != 'number') throw new D.ERR_INVALID_ARG_TYPE(r, 'number', i);
            }
            function G(i, r, t) {
                throw Math.floor(i) !== i
                    ? ($(i, t), new D.ERR_OUT_OF_RANGE(t || 'offset', 'an integer', i))
                    : r < 0
                    ? new D.ERR_BUFFER_OUT_OF_BOUNDS()
                    : new D.ERR_OUT_OF_RANGE(t || 'offset', `>= ${t ? 1 : 0} and <= ${r}`, i);
            }
