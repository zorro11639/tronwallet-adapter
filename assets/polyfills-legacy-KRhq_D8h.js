(function () {
	...
	function requireArrayBufferByteLength () {
		...
		arrayBufferByteLength = uncurryThisAccessor(ArrayBuffer.prototype, 'byteLength', 'get') || function (O) {
	...
	var tryNodeRequire;
	var hasRequiredTryNodeRequire;

	function requireTryNodeRequire () {
		if (hasRequiredTryNodeRequire) return tryNodeRequire;
		hasRequiredTryNodeRequire = 1;
	...
	function requireEngineIsBrowser () {
		...
		var IS_DENO = requireEngineIsDeno();
		var IS_NODE = requireEngineIsNode();
	...
	function requireStructuredCloneProperTransfer () {
		...
		var fails = requireFails();
		var V8 = requireEngineV8Version();
		var IS_BROWSER = requireEngineIsBrowser();
		var IS_DENO = requireEngineIsDeno();
		var IS_NODE = requireEngineIsNode();
	...
	function requireDetachTransferable () {
		...
		var global = requireGlobal();
		var tryNodeRequire = requireTryNodeRequire();
	...
	function requireMicrotask () {
		...
		var IS_IOS = requireEngineIsIos();
		var IS_IOS_PEBBLE = requireEngineIsIosPebble();
		var IS_WEBOS_WEBKIT = requireEngineIsWebosWebkit();
		var IS_NODE = requireEngineIsNode();
