...
var _a, _a2, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t2, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W, _X, _Y, _Z, __, _$, _aa, _ba, _ca, _da, _ea, _fa, _ga, _ha, _ia, _ja, _ka, _la, _ma, _na, _oa, _pa, _qa, _ra, _sa, _ta, _ua, _va, _wa, _xa, _ya, _za, _Aa, _Ba, _Ca, _Da, _Ea, _Fa, _Ga, _Ha, _Ia, _Ja, _Ka, _La, _Ma, _Na, _Oa, _Pa, _Qa, _Ra, _Sa, _Ta, _Ua, _Va, _Wa, _Xa, _Ya, _Za, __a, _$a, _ab, _bb, _cb, _db, _eb, _fb, _gb, _hb, _ib, _jb, _kb, _lb, _mb, _nb, _ob, _pb, _qb, _rb, _sb, _tb, _ub, _vb;
import { g as getDefaultExportFromCjs, s as se$1, n as ne$1, T as T$3, a as a$3, y as y$2, p as p$2, o as oe$1, t as te$1, R as R$2 } from "./index-CrccOd4r.js";
/**
 * @license
 ...
 */
var s$3;
const e$5 = window, r$2 = e$5.trustedTypes, h$3 = r$2 ? r$2.emptyScript : "", o$4 = e$5.reactiveElementPolyfillSupport, n$5 = { toAttribute(t2, i3) {
  switch (i3) {
    case Boolean:
      t2 = t2 ? h$3 : null;
      break;
...
let u$2 = class u extends HTMLElement {
  ...
  static finalizeStyles(i3) {
    ...
    if (Array.isArray(i3)) {
      ...
      for (const i4 of e2) s3.unshift(c$3(i4));
    } else void 0 !== i3 && s3.push(c$3(i3));
    return s3;
  }
  static _$Ep(t2, i3) {
  ...
  createRenderRoot() {
    ...
    return S$3(s3, this.constructor.elementStyles), s3;
  }
  connectedCallback() {
    var t2;
 ...
 */
var t$3;
const i$3 = window, s$2 = i$3.trustedTypes, e$4 = s$2 ? s$2.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$3 = "$lit$", n$4 = "lit$".concat((Math.random() + "").slice(9), "$"), l$3 = "?" + n$4, h$2 = "<".concat(l$3, ">"), r$1 = document, u$1 = () => r$1.createComment(""), d$1 = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c$2 = Array.isArray, v$2 = (t2) => c$2(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a$1 = "[ 	\n\f\r]", f$1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _$2 = /-->/g, m$1 = />/g, p$1 = RegExp(">|".concat(a$1, "(?:([^\\s\"'>=/]+)(").concat(a$1, "*=").concat(a$1, "*(?:[^ 	\n\f\r\"'`<>=]|(\"|')|))|$)"), "g"), g$1 = /'/g, $$1 = /"/g, y$1 = /^(?:script|style|textarea|title)$/i, w$1 = (t2) => (i3, ...s3) => ({ _$litType$: t2, strings: i3, values: s3 }), x = w$1(1), b$1 = w$1(2), T$2 = Symbol.for("lit-noChange"), A$2 = Symbol.for("lit-nothing"), E$1 = /* @__PURE__ */ new WeakMap(), C$1 = r$1.createTreeWalker(r$1, 129, null, false);
function P$1(t2, i3) {
...
const V$1 = (t2, i3) => {
  ...
  for (let i4 = 0; i4 < s3; i4++) {
    const s4 = t2[i4];
    let d2, c2, v2 = -1, a2 = 0;
    for (; a2 < s4.length && (u3.lastIndex = a2, c2 = u3.exec(s4), null !== c2); ) a2 = u3.lastIndex, u3 === f$1 ? "!--" === c2[1] ? u3 = _$2 : void 0 !== c2[1] ? u3 = m$1 : void 0 !== c2[2] ? (y$1.test(c2[2]) && (l2 = RegExp("</" + c2[2], "g")), u3 = p$1) : void 0 !== c2[3] && (u3 = p$1) : u3 === p$1 ? ">" === c2[0] ? (u3 = null != l2 ? l2 : f$1, v2 = -1) : void 0 === c2[1] ? v2 = -2 : (v2 = u3.lastIndex - c2[2].length, d2 = c2[1], u3 = void 0 === c2[3] ? p$1 : '"' === c2[3] ? $$1 : g$1) : u3 === $$1 || u3 === g$1 ? u3 = p$1 : u3 === _$2 || u3 === m$1 ? u3 = f$1 : (u3 = p$1, l2 = void 0);
    const w2 = u3 === p$1 && t2[i4 + 1].startsWith("/>") ? " " : "";
    r2 += u3 === f$1 ? s4 + h$2 : v2 >= 0 ? (e2.push(d2), s4.slice(0, v2) + o$3 + s4.slice(v2) + n$4 + w2) : s4 + n$4 + (-2 === v2 ? (e2.push(void 0), i4) : w2);
  }
        ...
        if (h2.hasAttributes()) {
          ...
          for (const i4 of h2.getAttributeNames()) if (i4.endsWith(o$3) || i4.startsWith(n$4)) {
            ...
            if (t3.push(i4), void 0 !== s3) {
              ...
              v2.push({ type: 1, index: r2, name: i5[2], strings: t4, ctor: "." === i5[1] ? H$1 : "?" === i5[1] ? L$2 : "@" === i5[1] ? z : k$1 });
...
function S$2(t2, i3, s3 = t2, e2) {
  var o3, n2, l2, h2;
  if (i3 === T$2) return i3;
  let r2 = void 0 !== e2 ? null === (o3 = s3._$Co) || void 0 === o3 ? void 0 : o3[e2] : s3._$Cl;
  const u3 = d$1(i3) ? void 0 : i3._$litDirective$;
  return (null == r2 ? void 0 : r2.constructor) !== u3 && (null === (n2 = null == r2 ? void 0 : r2._$AO) || void 0 === n2 || n2.call(r2, false), void 0 === u3 ? r2 = void 0 : (r2 = new u3(t2), r2._$AT(t2, s3, e2)), void 0 !== e2 ? (null !== (l2 = (h2 = s3)._$Co) && void 0 !== l2 ? l2 : h2._$Co = [])[e2] = r2 : s3._$Cl = r2), void 0 !== r2 && (i3 = S$2(t2, r2._$AS(t2, i3.values), r2, e2)), i3;
}
let M$1 = class M {
  constructor(t2, i3) {
  ...
  u(t2) {
    ...
    for (; void 0 !== u3; ) {
      if (l2 === u3.index) {
        let i4;
        2 === u3.type ? i4 = new R$1(n2, n2.nextSibling, this, t2) : 1 === u3.type ? i4 = new u3.ctor(n2, u3.name, u3.strings, this, t2) : 6 === u3.type && (i4 = new Z$2(n2, this, t2)), this._$AV.push(i4), u3 = e2[++h2];
      }
...
let R$1 = class R {
  constructor(t2, i3, s3, e2) {
    var o3;
    this.type = 2, this._$AH = A$2, this._$AN = void 0, this._$AA = t2, this._$AB = i3, this._$AM = s3, this.options = e2, this._$Cp = null === (o3 = null == e2 ? void 0 : e2.isConnected) || void 0 === o3 || o3;
  }
  get _$AU() {
    var t2, i3;
  ...
  _$AI(t2, i3 = this) {
    t2 = S$2(this, t2, i3), d$1(t2) ? t2 === A$2 || null == t2 || "" === t2 ? (this._$AH !== A$2 && this._$AR(), this._$AH = A$2) : t2 !== this._$AH && t2 !== T$2 && this._(t2) : void 0 !== t2._$litType$ ? this.g(t2) : void 0 !== t2.nodeType ? this.$(t2) : v$2(t2) ? this.T(t2) : this._(t2);
  }
  k(t2) {
  ...
  _(t2) {
    this._$AH !== A$2 && d$1(this._$AH) ? this._$AA.nextSibling.data = t2 : this.$(r$1.createTextNode(t2)), this._$AH = t2;
  }
  g(t2) {
    var i3;
...
let k$1 = class k {
  constructor(t2, i3, s3, e2, o3) {
    this.type = 1, this._$AH = A$2, this._$AN = void 0, this.element = t2, this.name = i3, this._$AM = e2, this.options = o3, s3.length > 2 || "" !== s3[0] || "" !== s3[1] ? (this._$AH = Array(s3.length - 1).fill(new String()), this.strings = s3) : this._$AH = A$2;
  }
  get tagName() {
  ...
  _$AI(t2, i3 = this, s3, e2) {
    ...
    let n2 = false;
    if (void 0 === o3) t2 = S$2(this, t2, i3, 0), n2 = !d$1(t2) || t2 !== this._$AH && t2 !== T$2, n2 && (this._$AH = t2);
    else {
      const e3 = t2;
      let l2, h2;
      for (t2 = o3[0], l2 = 0; l2 < o3.length - 1; l2++) h2 = S$2(this, e3[s3 + l2], i3, l2), h2 === T$2 && (h2 = this._$AH[l2]), n2 || (n2 = !d$1(h2) || h2 !== this._$AH[l2]), h2 === A$2 ? t2 = A$2 : t2 !== A$2 && (t2 += (null != h2 ? h2 : "") + o3[l2 + 1]), this._$AH[l2] = h2;
    }
    n2 && !e2 && this.j(t2);
  }
  j(t2) {
...
let L$2 = class L extends k$1 {
  ...
  j(t2) {
    t2 && t2 !== A$2 ? this.element.setAttribute(this.name, I$1) : this.element.removeAttribute(this.name);
  }
};
class z extends k$1 {
  constructor(t2, i3, s3, e2, o3) {
  ...
  _$AI(t2, i3 = this) {
    var s3;
    if ((t2 = null !== (s3 = S$2(this, t2, i3, 0)) && void 0 !== s3 ? s3 : A$2) === T$2) return;
    const e2 = this._$AH, o3 = t2 === A$2 && e2 !== A$2 || t2.capture !== e2.capture || t2.once !== e2.once || t2.passive !== e2.passive, n2 = t2 !== A$2 && (e2 === A$2 || o3);
...
let s$1 = class s extends u$2 {
  ...
  update(t2) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t2), this._$Do = D$1(i3, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t2;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t = globalThis, i2 = t.trustedTypes, s2 = i2 ? i2.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e = "$lit$", h$1 = "lit$".concat(Math.random().toFixed(9).slice(2), "$"), o2 = "?" + h$1, n = "<".concat(o2, ">"), r = document, l$1 = () => r.createComment(""), c$1 = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u2 = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v$1 = /-->/g, _$1 = />/g, m = RegExp(">|".concat(d, "(?:([^\\s\"'>=/]+)(").concat(d, "*=").concat(d, "*(?:[^ 	\n\f\r\"'`<>=]|(\"|')|))|$)"), "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i3, ...s3) => ({ _$litType$: t2, strings: i3, values: s3 }), b = y(2), w = Symbol.for("lit-noChange"), T$1 = Symbol.for("lit-nothing"), A$1 = /* @__PURE__ */ new WeakMap(), E = r.createTreeWalker(r, 129);
function C(t2, i3) {
  if (!Array.isArray(t2) || !t2.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const P = (t2, i3) => {
  ...
  for (let i4 = 0; i4 < s3; i4++) {
    const s4 = t2[i4];
    let a2, u3, d2 = -1, y2 = 0;
    for (; y2 < s4.length && (c2.lastIndex = y2, u3 = c2.exec(s4), null !== u3); ) y2 = c2.lastIndex, c2 === f ? "!--" === u3[1] ? c2 = v$1 : void 0 !== u3[1] ? c2 = _$1 : void 0 !== u3[2] ? ($.test(u3[2]) && (r2 = RegExp("</" + u3[2], "g")), c2 = m) : void 0 !== u3[3] && (c2 = m) : c2 === m ? ">" === u3[0] ? (c2 = r2 != null ? r2 : f, d2 = -1) : void 0 === u3[1] ? d2 = -2 : (d2 = c2.lastIndex - u3[2].length, a2 = u3[1], c2 = void 0 === u3[3] ? m : '"' === u3[3] ? g : p) : c2 === g || c2 === p ? c2 = m : c2 === v$1 || c2 === _$1 ? c2 = f : (c2 = m, r2 = void 0);
    const x2 = c2 === m && t2[i4 + 1].startsWith("/>") ? " " : "";
    l2 += c2 === f ? s4 + n : d2 >= 0 ? (o3.push(a2), s4.slice(0, d2) + e + s4.slice(d2) + h$1 + x2) : s4 + h$1 + (-2 === d2 ? i4 : x2);
  }
  return [C(t2, l2 + (t2[s3] || "<?>") + (2 === i3 ? "</svg>" : "")), o3];
};
class V {
  constructor({ strings: t2, _$litType$: s3 }, n2) {
    ...
    this.parts = [];
    let c2 = 0, a2 = 0;
    const u3 = t2.length - 1, d2 = this.parts, [f2, v2] = P(t2, s3);
    if (this.el = V.createElement(f2, n2), E.currentNode = this.el.content, 2 === s3) {
      const t3 = this.el.content.firstChild;
      t3.replaceWith(...t3.childNodes);
    }
    for (; null !== (r2 = E.nextNode()) && d2.length < u3; ) {
      if (1 === r2.nodeType) {
        if (r2.hasAttributes()) for (const t3 of r2.getAttributeNames()) if (t3.endsWith(e)) {
          const i3 = v2[a2++], s4 = r2.getAttribute(t3).split(h$1), e2 = /([.?@])?(.*)/.exec(i3);
          d2.push({ type: 1, index: c2, name: e2[2], strings: s4, ctor: "." === e2[1] ? k2 : "?" === e2[1] ? H2 : "@" === e2[1] ? I : R2 }), r2.removeAttribute(t3);
        ...
        if ($.test(r2.tagName)) {
          ...
          if (s4 > 0) {
            ...
            for (let i3 = 0; i3 < s4; i3++) r2.append(t3[i3], l$1()), E.nextNode(), d2.push({ type: 2, index: ++c2 });
            r2.append(t3[s4], l$1());
          }
        }
...
function N2(t2, i3, s3 = t2, e2) {
  var _a3, _b2, _c2;
  if (i3 === w) return i3;
  let h2 = void 0 !== e2 ? (_a3 = s3._$Co) == null ? void 0 : _a3[e2] : s3._$Cl;
  const o3 = c$1(i3) ? void 0 : i3._$litDirective$;
  return (h2 == null ? void 0 : h2.constructor) !== o3 && ((_b2 = h2 == null ? void 0 : h2._$AO) == null ? void 0 : _b2.call(h2, false), void 0 === o3 ? h2 = void 0 : (h2 = new o3(t2), h2._$AT(t2, s3, e2)), void 0 !== e2 ? ((_c2 = s3._$Co) != null ? _c2 : s3._$Co = [])[e2] = h2 : s3._$Cl = h2), void 0 !== h2 && (i3 = N2(t2, h2._$AS(t2, i3.values), h2, e2)), i3;
}
let S$1 = class S {
  constructor(t2, i3) {
    this._$AV = [], this._$AN = void 0, this._$AD = t2, this._$AM = i3;
  ...
  u(t2) {
    var _a3;
    const { el: { content: i3 }, parts: s3 } = this._$AD, e2 = ((_a3 = t2 == null ? void 0 : t2.creationScope) != null ? _a3 : r).importNode(i3, true);
    E.currentNode = e2;
    let h2 = E.nextNode(), o3 = 0, n2 = 0, l2 = s3[0];
    for (; void 0 !== l2; ) {
      if (o3 === l2.index) {
        let i4;
        2 === l2.type ? i4 = new M2(h2, h2.nextSibling, this, t2) : 1 === l2.type ? i4 = new l2.ctor(h2, l2.name, l2.strings, this, t2) : 6 === l2.type && (i4 = new L$1(h2, this, t2)), this._$AV.push(i4), l2 = s3[++n2];
      }
      o3 !== (l2 == null ? void 0 : l2.index) && (h2 = E.nextNode(), o3++);
    }
...
class M2 {
  get _$AU() {
    var _a3, _b2;
    return (_b2 = (_a3 = this._$AM) == null ? void 0 : _a3._$AU) != null ? _b2 : this._$Cv;
  }
  constructor(t2, i3, s3, e2) {
    var _a3;
    this.type = 2, this._$AH = T$1, this._$AN = void 0, this._$AA = t2, this._$AB = i3, this._$AM = s3, this.options = e2, this._$Cv = (_a3 = e2 == null ? void 0 : e2.isConnected) != null ? _a3 : true;
  }
  get parentNode() {
    let t2 = this._$AA.parentNode;
    const i3 = this._$AM;
  ...
  _$AI(t2, i3 = this) {
    t2 = N2(this, t2, i3), c$1(t2) ? t2 === T$1 || null == t2 || "" === t2 ? (this._$AH !== T$1 && this._$AR(), this._$AH = T$1) : t2 !== this._$AH && t2 !== w && this._(t2) : void 0 !== t2._$litType$ ? this.$(t2) : void 0 !== t2.nodeType ? this.T(t2) : u2(t2) ? this.k(t2) : this._(t2);
  }
  S(t2) {
    return this._$AA.parentNode.insertBefore(t2, this._$AB);
  }
  ...
  _(t2) {
    this._$AH !== T$1 && c$1(this._$AH) ? this._$AA.nextSibling.data = t2 : this.T(r.createTextNode(t2)), this._$AH = t2;
  }
  $(t2) {
    var _a3;
    const { values: i3, _$litType$: s3 } = t2, e2 = "number" == typeof s3 ? this._$AC(t2) : (void 0 === s3.el && (s3.el = V.createElement(C(s3.h, s3.h[0]), this.options)), s3);
  ...
  _$AC(t2) {
    ...
    return void 0 === i3 && A$1.set(t2.strings, i3 = new V(t2)), i3;
  }
  k(t2) {
    a(this._$AH) || (this._$AH = [], this._$AR());
    const i3 = this._$AH;
    let s3, e2 = 0;
    for (const h2 of t2) e2 === i3.length ? i3.push(s3 = new M2(this.S(l$1()), this.S(l$1()), this, this.options)) : s3 = i3[e2], s3._$AI(h2), e2++;
    e2 < i3.length && (this._$AR(s3 && s3._$AB.nextSibling, e2), i3.length = e2);
  }
  _$AR(t2 = this._$AA.nextSibling, i3) {
    var _a3;
...
class R2 {
  ...
  _$AI(t2, i3 = this, s3, e2) {
    ...
    let o3 = false;
    if (void 0 === h2) t2 = N2(this, t2, i3, 0), o3 = !c$1(t2) || t2 !== this._$AH && t2 !== w, o3 && (this._$AH = t2);
    else {
      const e3 = t2;
      let n2, r2;
      for (t2 = h2[0], n2 = 0; n2 < h2.length - 1; n2++) r2 = N2(this, e3[s3 + n2], i3, n2), r2 === w && (r2 = this._$AH[n2]), o3 || (o3 = !c$1(r2) || r2 !== this._$AH[n2]), r2 === T$1 ? t2 = T$1 : t2 !== T$1 && (t2 += (r2 != null ? r2 : "") + h2[n2 + 1]), this._$AH[n2] = r2;
    }
    o3 && !e2 && this.j(t2);
  }
  j(t2) {
    t2 === T$1 ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, t2 != null ? t2 : "");
  }
}
class k2 extends R2 {
  constructor() {
...
class I extends R2 {
  ...
  _$AI(t2, i3 = this) {
    var _a3;
    if ((t2 = (_a3 = N2(this, t2, i3, 0)) != null ? _a3 : T$1) === w) return;
  ...
  handleEvent(t2) {
    var _a3, _b2;
    "function" == typeof this._$AH ? this._$AH.call((_b2 = (_a3 = this.options) == null ? void 0 : _a3.host) != null ? _b2 : this.element, t2) : this._$AH.handleEvent(t2);
  }
}
let L$1 = class L2 {
  constructor(t2, i3, s3) {
...
const Z$1 = t.litHtmlPolyfillSupport;
Z$1 == null ? void 0 : Z$1(V, M2), ((_a = t.litHtmlVersions) != null ? _a : t.litHtmlVersions = []).push("3.1.4");
...
class Animation {
  constructor(output, keyframes = [0, 1], { easing, duration: initialDuration = defaults.duration, delay = defaults.delay, endDelay = defaults.endDelay, repeat = defaults.repeat, offset, direction = "normal", autoplay = true } = {}) {
    ...
    this.tick = (timestamp) => {
      ...
      if (isAnimationFinished) {
        ...
        (_a3 = this.resolve) === null || _a3 === void 0 ? void 0 : _a3.call(this, latest);
  ...
  stop() {
    ...
    (_a3 = this.reject) === null || _a3 === void 0 ? void 0 : _a3.call(this, false);
  }
  cancel() {
    this.stop();
...
const cubicBezierAsString = ([a2, b2, c2, d2]) => "cubic-bezier(".concat(a2, ", ").concat(b2, ", ").concat(c2, ", ").concat(d2, ")");
...
function getUnitConverter(keyframes, definition) {
  ...
  if (isString(finalKeyframe)) {
    const unit = ((_a3 = finalKeyframe.match(/(-?[\d.]+)([a-z%]*)/)) === null || _a3 === void 0 ? void 0 : _a3[2]) || "";
    if (unit)
...
function animateStyle(element, key, keyframesDefinition, options = {}, AnimationPolyfill) {
  ...
  return () => {
    const readInitialValue = () => {
      var _a3, _b2;
      return (_b2 = (_a3 = style.get(element, name)) !== null && _a3 !== void 0 ? _a3 : definition === null || definition === void 0 ? void 0 : definition.initialValue) !== null && _b2 !== void 0 ? _b2 : 0;
    };
...
let T = class extends s$1 {
  ...
  render() {
    ...
    let o3 = "inverse";
    return this.variant === "ghost" && (o3 = "secondary"), this.variant === "outline" && (o3 = "accent"), x(_c || (_c = __template(['<button class="', '" ?disabled="', '" @click="', '">', '<wcm-text variant="small-regular" color="', '"><slot></slot></wcm-text>', "</button>"])), o$1(e2), this.disabled, this.onClick, this.iconLeft, o3, this.iconRight);
  }
};
T.styles = [h.globalCss, at], F([n$2({ type: Boolean })], T.prototype, "disabled", 2), F([n$2()], T.prototype, "iconLeft", 2), F([n$2()], T.prototype, "iconRight", 2), F([n$2()], T.prototype, "onClick", 2), F([n$2()], T.prototype, "variant", 2), T = F([e$3("wcm-button")], T);
const nt = i$4(_d || (_d = __template([":host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}"])));
var ct = Object.defineProperty, st = Object.getOwnPropertyDescriptor, ue = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? st(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
  return a2 && t2 && ct(o3, r2, t2), t2;
};
let ee = class extends s$1 {
  constructor() {
    super(...arguments), this.disabled = false, this.variant = "primary";
  }
  render() {
    const e2 = { "wcm-secondary": this.variant === "secondary" };
    return x(_e2 || (_e2 = __template(['<button ?disabled="', '" class="', '"><slot></slot></button>'])), this.disabled, o$1(e2));
  }
};
ee.styles = [h.globalCss, nt], ue([n$2({ type: Boolean })], ee.prototype, "disabled", 2), ue([n$2()], ee.prototype, "variant", 2), ee = ue([e$3("wcm-button-big")], ee);
const dt = i$4(_f || (_f = __template([":host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}"])));
var wt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let be = class extends s$1 {
  render() {
    return x(_g || (_g = __template(["<div><slot></slot></div>"])));
  }
};
be.styles = [h.globalCss, dt], be = wt([e$3("wcm-info-footer")], be);
const v = { CROSS_ICON: b(_h || (_h = __template(['<svg width="12" height="12" viewBox="0 0 12 12"><path d="M9.94 11A.75.75 0 1 0 11 9.94L7.414 6.353a.5.5 0 0 1 0-.708L11 2.061A.75.75 0 1 0 9.94 1L6.353 4.586a.5.5 0 0 1-.708 0L2.061 1A.75.75 0 0 0 1 2.06l3.586 3.586a.5.5 0 0 1 0 .708L1 9.939A.75.75 0 1 0 2.06 11l3.586-3.586a.5.5 0 0 1 .708 0L9.939 11Z" fill="#fff"/></svg>']))), WALLET_CONNECT_LOGO: b(_i || (_i = __template(['<svg width="178" height="29" viewBox="0 0 178 29" id="wcm-wc-logo"><path d="M10.683 7.926c5.284-5.17 13.85-5.17 19.134 0l.636.623a.652.652 0 0 1 0 .936l-2.176 2.129a.343.343 0 0 1-.478 0l-.875-.857c-3.686-3.607-9.662-3.607-13.348 0l-.937.918a.343.343 0 0 1-.479 0l-2.175-2.13a.652.652 0 0 1 0-.936l.698-.683Zm23.633 4.403 1.935 1.895a.652.652 0 0 1 0 .936l-8.73 8.543a.687.687 0 0 1-.956 0L20.37 17.64a.172.172 0 0 0-.239 0l-6.195 6.063a.687.687 0 0 1-.957 0l-8.73-8.543a.652.652 0 0 1 0-.936l1.936-1.895a.687.687 0 0 1 .957 0l6.196 6.064a.172.172 0 0 0 .239 0l6.195-6.064a.687.687 0 0 1 .957 0l6.196 6.064a.172.172 0 0 0 .24 0l6.195-6.064a.687.687 0 0 1 .956 0ZM48.093 20.948l2.338-9.355c.139-.515.258-1.07.416-1.942.12.872.258 1.427.357 1.942l2.022 9.355h4.181l3.528-13.874h-3.21l-1.943 8.523a24.825 24.825 0 0 0-.456 2.457c-.158-.931-.317-1.625-.495-2.438l-1.883-8.542h-4.201l-2.042 8.542a41.204 41.204 0 0 0-.475 2.438 41.208 41.208 0 0 0-.476-2.438l-1.903-8.542h-3.349l3.508 13.874h4.083ZM63.33 21.304c1.585 0 2.596-.654 3.11-1.605-.059.297-.078.595-.078.892v.357h2.655V15.22c0-2.735-1.248-4.32-4.3-4.32-2.636 0-4.36 1.466-4.52 3.487h2.914c.1-.891.734-1.426 1.705-1.426.911 0 1.407.515 1.407 1.11 0 .435-.258.693-1.03.792l-1.388.159c-2.061.257-3.825 1.01-3.825 3.19 0 1.982 1.645 3.092 3.35 3.092Zm.891-2.041c-.773 0-1.348-.436-1.348-1.19 0-.733.655-1.09 1.645-1.268l.674-.119c.575-.118.892-.218 1.09-.396v.912c0 1.228-.892 2.06-2.06 2.06ZM70.398 7.074v13.874h2.874V7.074h-2.874ZM74.934 7.074v13.874h2.874V7.074h-2.874ZM84.08 21.304c2.735 0 4.5-1.546 4.697-3.567h-2.893c-.139.892-.892 1.387-1.804 1.387-1.228 0-2.12-.99-2.14-2.358h6.897v-.555c0-3.21-1.764-5.312-4.816-5.312-2.933 0-4.994 2.062-4.994 5.173 0 3.37 2.12 5.232 5.053 5.232Zm-2.16-6.421c.119-1.11.932-1.922 2.081-1.922 1.11 0 1.883.772 1.903 1.922H81.92ZM94.92 21.146c.633 0 1.248-.1 1.525-.179v-2.18c-.218.04-.475.06-.693.06-1.05 0-1.427-.595-1.427-1.566v-3.805h2.338v-2.24h-2.338V7.788H91.47v3.448H89.37v2.24h2.1v4.201c0 2.3 1.15 3.469 3.45 3.469ZM104.62 21.304c3.924 0 6.302-2.299 6.599-5.608h-3.111c-.238 1.803-1.506 3.032-3.369 3.032-2.2 0-3.746-1.784-3.746-4.796 0-2.953 1.605-4.638 3.805-4.638 1.883 0 2.953 1.15 3.171 2.834h3.191c-.317-3.448-2.854-5.41-6.342-5.41-3.984 0-7.036 2.695-7.036 7.214 0 4.677 2.676 7.372 6.838 7.372ZM117.449 21.304c2.993 0 5.114-1.882 5.114-5.172 0-3.23-2.121-5.233-5.114-5.233-2.972 0-5.093 2.002-5.093 5.233 0 3.29 2.101 5.172 5.093 5.172Zm0-2.22c-1.327 0-2.18-1.09-2.18-2.952 0-1.903.892-2.973 2.18-2.973 1.308 0 2.2 1.07 2.2 2.973 0 1.862-.872 2.953-2.2 2.953ZM126.569 20.948v-5.689c0-1.208.753-2.1 1.823-2.1 1.011 0 1.606.773 1.606 2.06v5.729h2.873v-6.144c0-2.339-1.229-3.905-3.428-3.905-1.526 0-2.458.734-2.953 1.606a5.31 5.31 0 0 0 .079-.892v-.377h-2.874v9.712h2.874ZM137.464 20.948v-5.689c0-1.208.753-2.1 1.823-2.1 1.011 0 1.606.773 1.606 2.06v5.729h2.873v-6.144c0-2.339-1.228-3.905-3.428-3.905-1.526 0-2.458.734-2.953 1.606a5.31 5.31 0 0 0 .079-.892v-.377h-2.874v9.712h2.874ZM149.949 21.304c2.735 0 4.499-1.546 4.697-3.567h-2.893c-.139.892-.892 1.387-1.804 1.387-1.228 0-2.12-.99-2.14-2.358h6.897v-.555c0-3.21-1.764-5.312-4.816-5.312-2.933 0-4.994 2.062-4.994 5.173 0 3.37 2.12 5.232 5.053 5.232Zm-2.16-6.421c.119-1.11.932-1.922 2.081-1.922 1.11 0 1.883.772 1.903 1.922h-3.984ZM160.876 21.304c3.013 0 4.658-1.645 4.975-4.201h-2.874c-.099 1.07-.713 1.982-2.001 1.982-1.309 0-2.2-1.21-2.2-2.993 0-1.942 1.03-2.933 2.259-2.933 1.209 0 1.803.872 1.883 1.882h2.873c-.218-2.358-1.823-4.142-4.776-4.142-2.874 0-5.153 1.903-5.153 5.193 0 3.25 1.923 5.212 5.014 5.212ZM172.067 21.146c.634 0 1.248-.1 1.526-.179v-2.18c-.218.04-.476.06-.694.06-1.05 0-1.427-.595-1.427-1.566v-3.805h2.339v-2.24h-2.339V7.788h-2.854v3.448h-2.1v2.24h2.1v4.201c0 2.3 1.15 3.469 3.449 3.469Z" fill="#fff"/></svg>']))), WALLET_CONNECT_ICON: b(_j || (_j = __template(['<svg width="28" height="20" viewBox="0 0 28 20"><g clip-path="url(#a)"><path d="M7.386 6.482c3.653-3.576 9.575-3.576 13.228 0l.44.43a.451.451 0 0 1 0 .648L19.55 9.033a.237.237 0 0 1-.33 0l-.606-.592c-2.548-2.496-6.68-2.496-9.228 0l-.648.634a.237.237 0 0 1-.33 0L6.902 7.602a.451.451 0 0 1 0-.647l.483-.473Zm16.338 3.046 1.339 1.31a.451.451 0 0 1 0 .648l-6.035 5.909a.475.475 0 0 1-.662 0L14.083 13.2a.119.119 0 0 0-.166 0l-4.283 4.194a.475.475 0 0 1-.662 0l-6.035-5.91a.451.451 0 0 1 0-.647l1.338-1.31a.475.475 0 0 1 .662 0l4.283 4.194c.046.044.12.044.166 0l4.283-4.194a.475.475 0 0 1 .662 0l4.283 4.194c.046.044.12.044.166 0l4.283-4.194a.475.475 0 0 1 .662 0Z" fill="#000000"/></g><defs><clipPath id="a"><path fill="#ffffff" d="M0 0h28v20H0z"/></clipPath></defs></svg>']))), WALLET_CONNECT_ICON_COLORED: b(_k || (_k = __template(['<svg width="96" height="96" fill="none"><path fill="#fff" d="M25.322 33.597c12.525-12.263 32.83-12.263 45.355 0l1.507 1.476a1.547 1.547 0 0 1 0 2.22l-5.156 5.048a.814.814 0 0 1-1.134 0l-2.074-2.03c-8.737-8.555-22.903-8.555-31.64 0l-2.222 2.175a.814.814 0 0 1-1.134 0l-5.156-5.049a1.547 1.547 0 0 1 0-2.22l1.654-1.62Zm56.019 10.44 4.589 4.494a1.547 1.547 0 0 1 0 2.22l-20.693 20.26a1.628 1.628 0 0 1-2.267 0L48.283 56.632a.407.407 0 0 0-.567 0L33.03 71.012a1.628 1.628 0 0 1-2.268 0L10.07 50.75a1.547 1.547 0 0 1 0-2.22l4.59-4.494a1.628 1.628 0 0 1 2.267 0l14.687 14.38c.156.153.41.153.567 0l14.685-14.38a1.628 1.628 0 0 1 2.268 0l14.687 14.38c.156.153.41.153.567 0l14.686-14.38a1.628 1.628 0 0 1 2.268 0Z"/><path stroke="#000" d="M25.672 33.954c12.33-12.072 32.325-12.072 44.655 0l1.508 1.476a1.047 1.047 0 0 1 0 1.506l-5.157 5.048a.314.314 0 0 1-.434 0l-2.074-2.03c-8.932-8.746-23.409-8.746-32.34 0l-2.222 2.174a.314.314 0 0 1-.434 0l-5.157-5.048a1.047 1.047 0 0 1 0-1.506l1.655-1.62Zm55.319 10.44 4.59 4.494a1.047 1.047 0 0 1 0 1.506l-20.694 20.26a1.128 1.128 0 0 1-1.568 0l-14.686-14.38a.907.907 0 0 0-1.267 0L32.68 70.655a1.128 1.128 0 0 1-1.568 0L10.42 50.394a1.047 1.047 0 0 1 0-1.506l4.59-4.493a1.128 1.128 0 0 1 1.567 0l14.687 14.379a.907.907 0 0 0 1.266 0l-.35-.357.35.357 14.686-14.38a1.128 1.128 0 0 1 1.568 0l14.687 14.38a.907.907 0 0 0 1.267 0l14.686-14.38a1.128 1.128 0 0 1 1.568 0Z"/></svg>']))), BACK_ICON: b(_l || (_l = __template(['<svg width="10" height="18" viewBox="0 0 10 18"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.735.179a.75.75 0 0 1 .087 1.057L2.92 8.192a1.25 1.25 0 0 0 0 1.617l5.902 6.956a.75.75 0 1 1-1.144.97L1.776 10.78a2.75 2.75 0 0 1 0-3.559L7.678.265A.75.75 0 0 1 8.735.18Z" fill="#fff"/></svg>']))), COPY_ICON: b(_m || (_m = __template(['<svg width="24" height="24" fill="none"><path fill="#fff" fill-rule="evenodd" d="M7.01 7.01c.03-1.545.138-2.5.535-3.28A5 5 0 0 1 9.73 1.545C10.8 1 12.2 1 15 1c2.8 0 4.2 0 5.27.545a5 5 0 0 1 2.185 2.185C23 4.8 23 6.2 23 9c0 2.8 0 4.2-.545 5.27a5 5 0 0 1-2.185 2.185c-.78.397-1.735.505-3.28.534l-.001.01c-.03 1.54-.138 2.493-.534 3.27a5 5 0 0 1-2.185 2.186C13.2 23 11.8 23 9 23c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C1 19.2 1 17.8 1 15c0-2.8 0-4.2.545-5.27A5 5 0 0 1 3.73 7.545C4.508 7.149 5.46 7.04 7 7.01h.01ZM15 15.5c-1.425 0-2.403-.001-3.162-.063-.74-.06-1.139-.172-1.427-.319a3.5 3.5 0 0 1-1.53-1.529c-.146-.288-.257-.686-.318-1.427C8.501 11.403 8.5 10.425 8.5 9c0-1.425.001-2.403.063-3.162.06-.74.172-1.139.318-1.427a3.5 3.5 0 0 1 1.53-1.53c.288-.146.686-.257 1.427-.318.759-.062 1.737-.063 3.162-.063 1.425 0 2.403.001 3.162.063.74.06 1.139.172 1.427.318a3.5 3.5 0 0 1 1.53 1.53c.146.288.257.686.318 1.427.062.759.063 1.737.063 3.162 0 1.425-.001 2.403-.063 3.162-.06.74-.172 1.139-.319 1.427a3.5 3.5 0 0 1-1.529 1.53c-.288.146-.686.257-1.427.318-.759.062-1.737.063-3.162.063ZM7 8.511c-.444.009-.825.025-1.162.052-.74.06-1.139.172-1.427.318a3.5 3.5 0 0 0-1.53 1.53c-.146.288-.257.686-.318 1.427-.062.759-.063 1.737-.063 3.162 0 1.425.001 2.403.063 3.162.06.74.172 1.139.318 1.427a3.5 3.5 0 0 0 1.53 1.53c.288.146.686.257 1.427.318.759.062 1.737.063 3.162.063 1.425 0 2.403-.001 3.162-.063.74-.06 1.139-.172 1.427-.319a3.5 3.5 0 0 0 1.53-1.53c.146-.287.257-.685.318-1.426.027-.337.043-.718.052-1.162H15c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C7 13.2 7 11.8 7 9v-.489Z" clip-rule="evenodd"/></svg>']))), RETRY_ICON: b(_n || (_n = __template(['<svg width="15" height="16" viewBox="0 0 15 16"><path d="M6.464 2.03A.75.75 0 0 0 5.403.97L2.08 4.293a1 1 0 0 0 0 1.414L5.403 9.03a.75.75 0 0 0 1.06-1.06L4.672 6.177a.25.25 0 0 1 .177-.427h2.085a4 4 0 1 1-3.93 4.746c-.077-.407-.405-.746-.82-.746-.414 0-.755.338-.7.748a5.501 5.501 0 1 0 5.45-6.248H4.848a.25.25 0 0 1-.177-.427L6.464 2.03Z" fill="#fff"/></svg>']))), DESKTOP_ICON: b(_o || (_o = __template(['<svg width="16" height="16" viewBox="0 0 16 16"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 5.98c0-1.85 0-2.775.394-3.466a3 3 0 0 1 1.12-1.12C2.204 1 3.13 1 4.98 1h6.04c1.85 0 2.775 0 3.466.394a3 3 0 0 1 1.12 1.12C16 3.204 16 4.13 16 5.98v1.04c0 1.85 0 2.775-.394 3.466a3 3 0 0 1-1.12 1.12C13.796 12 12.87 12 11.02 12H4.98c-1.85 0-2.775 0-3.466-.394a3 3 0 0 1-1.12-1.12C0 9.796 0 8.87 0 7.02V5.98ZM4.98 2.5h6.04c.953 0 1.568.001 2.034.043.446.04.608.108.69.154a1.5 1.5 0 0 1 .559.56c.046.08.114.243.154.69.042.465.043 1.08.043 2.033v1.04c0 .952-.001 1.568-.043 2.034-.04.446-.108.608-.154.69a1.499 1.499 0 0 1-.56.559c-.08.046-.243.114-.69.154-.466.042-1.08.043-2.033.043H4.98c-.952 0-1.568-.001-2.034-.043-.446-.04-.608-.108-.69-.154a1.5 1.5 0 0 1-.559-.56c-.046-.08-.114-.243-.154-.69-.042-.465-.043-1.08-.043-2.033V5.98c0-.952.001-1.568.043-2.034.04-.446.108-.608.154-.69a1.5 1.5 0 0 1 .56-.559c.08-.046.243-.114.69-.154.465-.042 1.08-.043 2.033-.043Z" fill="#fff"/><path d="M4 14.25a.75.75 0 0 1 .75-.75h6.5a.75.75 0 0 1 0 1.5h-6.5a.75.75 0 0 1-.75-.75Z" fill="#fff"/></svg>']))), MOBILE_ICON: b(_p || (_p = __template(['<svg width="16" height="16" viewBox="0 0 16 16"><path d="M6.75 5a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5Z" fill="#fff"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 4.98c0-1.85 0-2.775.394-3.466a3 3 0 0 1 1.12-1.12C5.204 0 6.136 0 8 0s2.795 0 3.486.394a3 3 0 0 1 1.12 1.12C13 2.204 13 3.13 13 4.98v6.04c0 1.85 0 2.775-.394 3.466a3 3 0 0 1-1.12 1.12C10.796 16 9.864 16 8 16s-2.795 0-3.486-.394a3 3 0 0 1-1.12-1.12C3 13.796 3 12.87 3 11.02V4.98Zm8.5 0v6.04c0 .953-.001 1.568-.043 2.034-.04.446-.108.608-.154.69a1.499 1.499 0 0 1-.56.559c-.08.045-.242.113-.693.154-.47.042-1.091.043-2.05.043-.959 0-1.58-.001-2.05-.043-.45-.04-.613-.109-.693-.154a1.5 1.5 0 0 1-.56-.56c-.046-.08-.114-.243-.154-.69-.042-.466-.043-1.08-.043-2.033V4.98c0-.952.001-1.568.043-2.034.04-.446.108-.608.154-.69a1.5 1.5 0 0 1 .56-.559c.08-.045.243-.113.693-.154C6.42 1.501 7.041 1.5 8 1.5c.959 0 1.58.001 2.05.043.45.04.613.109.693.154a1.5 1.5 0 0 1 .56.56c.046.08.114.243.154.69.042.465.043 1.08.043 2.033Z" fill="#fff"/></svg>']))), ARROW_DOWN_ICON: b(_q || (_q = __template(['<svg width="14" height="14" viewBox="0 0 14 14"><path d="M2.28 7.47a.75.75 0 0 0-1.06 1.06l5.25 5.25a.75.75 0 0 0 1.06 0l5.25-5.25a.75.75 0 0 0-1.06-1.06l-3.544 3.543a.25.25 0 0 1-.426-.177V.75a.75.75 0 0 0-1.5 0v10.086a.25.25 0 0 1-.427.176L2.28 7.47Z" fill="#fff"/></svg>']))), ARROW_UP_RIGHT_ICON: b(_r || (_r = __template(['<svg width="15" height="14" fill="none"><path d="M4.5 1.75A.75.75 0 0 1 5.25 1H12a1.5 1.5 0 0 1 1.5 1.5v6.75a.75.75 0 0 1-1.5 0V4.164a.25.25 0 0 0-.427-.176L4.061 11.5A.75.75 0 0 1 3 10.44l7.513-7.513a.25.25 0 0 0-.177-.427H5.25a.75.75 0 0 1-.75-.75Z" fill="#fff"/></svg>']))), ARROW_RIGHT_ICON: b(_s || (_s = __template(['<svg width="6" height="14" viewBox="0 0 6 14"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.181 1.099a.75.75 0 0 1 1.024.279l2.433 4.258a2.75 2.75 0 0 1 0 2.729l-2.433 4.257a.75.75 0 1 1-1.303-.744L4.335 7.62a1.25 1.25 0 0 0 0-1.24L1.902 2.122a.75.75 0 0 1 .28-1.023Z" fill="#fff"/></svg>']))), QRCODE_ICON: b(_t2 || (_t2 = __template(['<svg width="25" height="24" viewBox="0 0 25 24"><path d="M23.748 9a.748.748 0 0 0 .748-.752c-.018-2.596-.128-4.07-.784-5.22a6 6 0 0 0-2.24-2.24c-1.15-.656-2.624-.766-5.22-.784a.748.748 0 0 0-.752.748c0 .414.335.749.748.752 1.015.007 1.82.028 2.494.088.995.09 1.561.256 1.988.5.7.398 1.28.978 1.679 1.678.243.427.41.993.498 1.988.061.675.082 1.479.09 2.493a.753.753 0 0 0 .75.749ZM3.527.788C4.677.132 6.152.022 8.747.004A.748.748 0 0 1 9.5.752a.753.753 0 0 1-.749.752c-1.014.007-1.818.028-2.493.088-.995.09-1.561.256-1.988.5-.7.398-1.28.978-1.679 1.678-.243.427-.41.993-.499 1.988-.06.675-.081 1.479-.088 2.493A.753.753 0 0 1 1.252 9a.748.748 0 0 1-.748-.752c.018-2.596.128-4.07.784-5.22a6 6 0 0 1 2.24-2.24ZM1.252 15a.748.748 0 0 0-.748.752c.018 2.596.128 4.07.784 5.22a6 6 0 0 0 2.24 2.24c1.15.656 2.624.766 5.22.784a.748.748 0 0 0 .752-.748.753.753 0 0 0-.749-.752c-1.014-.007-1.818-.028-2.493-.089-.995-.089-1.561-.255-1.988-.498a4.5 4.5 0 0 1-1.679-1.68c-.243-.426-.41-.992-.499-1.987-.06-.675-.081-1.479-.088-2.493A.753.753 0 0 0 1.252 15ZM22.996 15.749a.753.753 0 0 1 .752-.749c.415 0 .751.338.748.752-.018 2.596-.128 4.07-.784 5.22a6 6 0 0 1-2.24 2.24c-1.15.656-2.624.766-5.22.784a.748.748 0 0 1-.752-.748c0-.414.335-.749.748-.752 1.015-.007 1.82-.028 2.494-.089.995-.089 1.561-.255 1.988-.498a4.5 4.5 0 0 0 1.679-1.68c.243-.426.41-.992.498-1.987.061-.675.082-1.479.09-2.493Z" fill="#fff"/><path fill-rule="evenodd" clip-rule="evenodd" d="M7 4a2.5 2.5 0 0 0-2.5 2.5v2A2.5 2.5 0 0 0 7 11h2a2.5 2.5 0 0 0 2.5-2.5v-2A2.5 2.5 0 0 0 9 4H7Zm2 1.5H7a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1ZM13.5 6.5A2.5 2.5 0 0 1 16 4h2a2.5 2.5 0 0 1 2.5 2.5v2A2.5 2.5 0 0 1 18 11h-2a2.5 2.5 0 0 1-2.5-2.5v-2Zm2.5-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1ZM7 13a2.5 2.5 0 0 0-2.5 2.5v2A2.5 2.5 0 0 0 7 20h2a2.5 2.5 0 0 0 2.5-2.5v-2A2.5 2.5 0 0 0 9 13H7Zm2 1.5H7a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1Z" fill="#fff"/><path d="M13.5 15.5c0-.465 0-.697.038-.89a2 2 0 0 1 1.572-1.572C15.303 13 15.535 13 16 13v2.5h-2.5ZM18 13c.465 0 .697 0 .89.038a2 2 0 0 1 1.572 1.572c.038.193.038.425.038.89H18V13ZM18 17.5h2.5c0 .465 0 .697-.038.89a2 2 0 0 1-1.572 1.572C18.697 20 18.465 20 18 20v-2.5ZM13.5 17.5H16V20c-.465 0-.697 0-.89-.038a2 2 0 0 1-1.572-1.572c-.038-.193-.038-.425-.038-.89Z" fill="#fff"/></svg>']))), SCAN_ICON: b(_u || (_u = __template(['<svg width="16" height="16" fill="none"><path fill="#fff" d="M10 15.216c0 .422.347.763.768.74 1.202-.064 2.025-.222 2.71-.613a5.001 5.001 0 0 0 1.865-1.866c.39-.684.549-1.507.613-2.709a.735.735 0 0 0-.74-.768.768.768 0 0 0-.76.732c-.009.157-.02.306-.032.447-.073.812-.206 1.244-.384 1.555-.31.545-.761.996-1.306 1.306-.311.178-.743.311-1.555.384-.141.013-.29.023-.447.032a.768.768 0 0 0-.732.76ZM10 .784c0 .407.325.737.732.76.157.009.306.02.447.032.812.073 1.244.206 1.555.384a3.5 3.5 0 0 1 1.306 1.306c.178.311.311.743.384 1.555.013.142.023.29.032.447a.768.768 0 0 0 .76.732.734.734 0 0 0 .74-.768c-.064-1.202-.222-2.025-.613-2.71A5 5 0 0 0 13.477.658c-.684-.39-1.507-.549-2.709-.613a.735.735 0 0 0-.768.74ZM5.232.044A.735.735 0 0 1 6 .784a.768.768 0 0 1-.732.76c-.157.009-.305.02-.447.032-.812.073-1.244.206-1.555.384A3.5 3.5 0 0 0 1.96 3.266c-.178.311-.311.743-.384 1.555-.013.142-.023.29-.032.447A.768.768 0 0 1 .784 6a.735.735 0 0 1-.74-.768c.064-1.202.222-2.025.613-2.71A5 5 0 0 1 2.523.658C3.207.267 4.03.108 5.233.044ZM5.268 14.456a.768.768 0 0 1 .732.76.734.734 0 0 1-.768.74c-1.202-.064-2.025-.222-2.71-.613a5 5 0 0 1-1.865-1.866c-.39-.684-.549-1.507-.613-2.709A.735.735 0 0 1 .784 10c.407 0 .737.325.76.732.009.157.02.306.032.447.073.812.206 1.244.384 1.555a3.5 3.5 0 0 0 1.306 1.306c.311.178.743.311 1.555.384.142.013.29.023.447.032Z"/></svg>']))), CHECKMARK_ICON: b(_v || (_v = __template(['<svg width="13" height="12" viewBox="0 0 13 12"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.155.132a.75.75 0 0 1 .232 1.035L5.821 11.535a1 1 0 0 1-1.626.09L.665 7.21a.75.75 0 1 1 1.17-.937L4.71 9.867a.25.25 0 0 0 .406-.023L11.12.364a.75.75 0 0 1 1.035-.232Z" fill="#fff"/></svg>']))), SEARCH_ICON: b(_w || (_w = __template(['<svg width="20" height="21"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.432 13.992c-.354-.353-.91-.382-1.35-.146a5.5 5.5 0 1 1 2.265-2.265c-.237.441-.208.997.145 1.35l3.296 3.296a.75.75 0 1 1-1.06 1.061l-3.296-3.296Zm.06-5a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" fill="#949E9E"/></svg>']))), WALLET_PLACEHOLDER: b(_x || (_x = __template(['<svg width="60" height="60" fill="none" viewBox="0 0 60 60"><g clip-path="url(#q)"><path id="wallet-placeholder-fill" fill="#fff" d="M0 24.9c0-9.251 0-13.877 1.97-17.332a15 15 0 0 1 5.598-5.597C11.023 0 15.648 0 24.9 0h10.2c9.252 0 13.877 0 17.332 1.97a15 15 0 0 1 5.597 5.598C60 11.023 60 15.648 60 24.9v10.2c0 9.252 0 13.877-1.97 17.332a15.001 15.001 0 0 1-5.598 5.597C48.977 60 44.352 60 35.1 60H24.9c-9.251 0-13.877 0-17.332-1.97a15 15 0 0 1-5.597-5.598C0 48.977 0 44.352 0 35.1V24.9Z"/><path id="wallet-placeholder-dash" stroke="#000" stroke-dasharray="4 4" stroke-width="1.5" d="M.04 41.708a231.598 231.598 0 0 1-.039-4.403l.75-.001L.75 35.1v-2.55H0v-5.1h.75V24.9l.001-2.204h-.75c.003-1.617.011-3.077.039-4.404l.75.016c.034-1.65.099-3.08.218-4.343l-.746-.07c.158-1.678.412-3.083.82-4.316l.713.236c.224-.679.497-1.296.827-1.875a14.25 14.25 0 0 1 1.05-1.585L3.076 5.9A15 15 0 0 1 5.9 3.076l.455.596a14.25 14.25 0 0 1 1.585-1.05c.579-.33 1.196-.603 1.875-.827l-.236-.712C10.812.674 12.217.42 13.895.262l.07.746C15.23.89 16.66.824 18.308.79l-.016-.75C19.62.012 21.08.004 22.695.001l.001.75L24.9.75h2.55V0h5.1v.75h2.55l2.204.001v-.75c1.617.003 3.077.011 4.404.039l-.016.75c1.65.034 3.08.099 4.343.218l.07-.746c1.678.158 3.083.412 4.316.82l-.236.713c.679.224 1.296.497 1.875.827a14.24 14.24 0 0 1 1.585 1.05l.455-.596A14.999 14.999 0 0 1 56.924 5.9l-.596.455c.384.502.735 1.032 1.05 1.585.33.579.602 1.196.827 1.875l.712-.236c.409 1.233.663 2.638.822 4.316l-.747.07c.119 1.264.184 2.694.218 4.343l.75-.016c.028 1.327.036 2.787.039 4.403l-.75.001.001 2.204v2.55H60v5.1h-.75v2.55l-.001 2.204h.75a231.431 231.431 0 0 1-.039 4.404l-.75-.016c-.034 1.65-.099 3.08-.218 4.343l.747.07c-.159 1.678-.413 3.083-.822 4.316l-.712-.236a10.255 10.255 0 0 1-.827 1.875 14.242 14.242 0 0 1-1.05 1.585l.596.455a14.997 14.997 0 0 1-2.824 2.824l-.455-.596c-.502.384-1.032.735-1.585 1.05-.579.33-1.196.602-1.875.827l.236.712c-1.233.409-2.638.663-4.316.822l-.07-.747c-1.264.119-2.694.184-4.343.218l.016.75c-1.327.028-2.787.036-4.403.039l-.001-.75-2.204.001h-2.55V60h-5.1v-.75H24.9l-2.204-.001v.75a231.431 231.431 0 0 1-4.404-.039l.016-.75c-1.65-.034-3.08-.099-4.343-.218l-.07.747c-1.678-.159-3.083-.413-4.316-.822l.236-.712a10.258 10.258 0 0 1-1.875-.827 14.252 14.252 0 0 1-1.585-1.05l-.455.596A14.999 14.999 0 0 1 3.076 54.1l.596-.455a14.24 14.24 0 0 1-1.05-1.585 10.259 10.259 0 0 1-.827-1.875l-.712.236C.674 49.188.42 47.783.262 46.105l.746-.07C.89 44.77.824 43.34.79 41.692l-.75.016Z"/><path fill="#fff" fill-rule="evenodd" d="M35.643 32.145c-.297-.743-.445-1.114-.401-1.275a.42.42 0 0 1 .182-.27c.134-.1.463-.1 1.123-.1.742 0 1.499.046 2.236-.05a6 6 0 0 0 5.166-5.166c.051-.39.051-.855.051-1.784 0-.928 0-1.393-.051-1.783a6 6 0 0 0-5.166-5.165c-.39-.052-.854-.052-1.783-.052h-7.72c-4.934 0-7.401 0-9.244 1.051a8 8 0 0 0-2.985 2.986C16.057 22.28 16.003 24.58 16 29 15.998 31.075 16 33.15 16 35.224A7.778 7.778 0 0 0 23.778 43H28.5c1.394 0 2.09 0 2.67-.116a6 6 0 0 0 4.715-4.714c.115-.58.115-1.301.115-2.744 0-1.31 0-1.964-.114-2.49a4.998 4.998 0 0 0-.243-.792Z" clip-rule="evenodd"/><path fill="#9EA9A9" fill-rule="evenodd" d="M37 18h-7.72c-2.494 0-4.266.002-5.647.126-1.361.122-2.197.354-2.854.728a6.5 6.5 0 0 0-2.425 2.426c-.375.657-.607 1.492-.729 2.853-.11 1.233-.123 2.777-.125 4.867 0 .7 0 1.05.097 1.181.096.13.182.181.343.2.163.02.518-.18 1.229-.581a6.195 6.195 0 0 1 3.053-.8H37c.977 0 1.32-.003 1.587-.038a4.5 4.5 0 0 0 3.874-3.874c.036-.268.039-.611.039-1.588 0-.976-.003-1.319-.038-1.587a4.5 4.5 0 0 0-3.875-3.874C38.32 18.004 37.977 18 37 18Zm-7.364 12.5h-7.414a4.722 4.722 0 0 0-4.722 4.723 6.278 6.278 0 0 0 6.278 6.278H28.5c1.466 0 1.98-.008 2.378-.087a4.5 4.5 0 0 0 3.535-3.536c.08-.397.087-.933.087-2.451 0-1.391-.009-1.843-.08-2.17a3.5 3.5 0 0 0-2.676-2.676c-.328-.072-.762-.08-2.108-.08Z" clip-rule="evenodd"/></g><defs><clipPath id="q"><path fill="#fff" d="M0 0h60v60H0z"/></clipPath></defs></svg>']))), GLOBE_ICON: b(_y || (_y = __template(['<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path fill="#fff" fill-rule="evenodd" d="M15.5 8a7.5 7.5 0 1 1-15 0 7.5 7.5 0 0 1 15 0Zm-2.113.75c.301 0 .535.264.47.558a6.01 6.01 0 0 1-2.867 3.896c-.203.116-.42-.103-.334-.32.409-1.018.691-2.274.797-3.657a.512.512 0 0 1 .507-.477h1.427Zm.47-2.058c.065.294-.169.558-.47.558H11.96a.512.512 0 0 1-.507-.477c-.106-1.383-.389-2.638-.797-3.656-.087-.217.13-.437.333-.32a6.01 6.01 0 0 1 2.868 3.895Zm-4.402.558c.286 0 .515-.24.49-.525-.121-1.361-.429-2.534-.83-3.393-.279-.6-.549-.93-.753-1.112a.535.535 0 0 0-.724 0c-.204.182-.474.513-.754 1.112-.4.859-.708 2.032-.828 3.393a.486.486 0 0 0 .49.525h2.909Zm-5.415 0c.267 0 .486-.21.507-.477.106-1.383.389-2.638.797-3.656.087-.217-.13-.437-.333-.32a6.01 6.01 0 0 0-2.868 3.895c-.065.294.169.558.47.558H4.04ZM2.143 9.308c-.065-.294.169-.558.47-.558H4.04c.267 0 .486.21.507.477.106 1.383.389 2.639.797 3.657.087.217-.13.436-.333.32a6.01 6.01 0 0 1-2.868-3.896Zm3.913-.033a.486.486 0 0 1 .49-.525h2.909c.286 0 .515.24.49.525-.121 1.361-.428 2.535-.83 3.394-.279.6-.549.93-.753 1.112a.535.535 0 0 1-.724 0c-.204-.182-.474-.513-.754-1.112-.4-.859-.708-2.033-.828-3.394Z" clip-rule="evenodd"/></svg>']))) }, pt = i$4(_z || (_z = __template([".wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}"])));
var ut = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let fe = class extends s$1 {
  render() {
    return x(_A || (_A = __template(['<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">', ' <button @click="', '">', "</button></div>"])), v.WALLET_CONNECT_LOGO, se$1.close, v.CROSS_ICON);
  }
};
fe.styles = [h.globalCss, pt], fe = ut([e$3("wcm-modal-backcard")], fe);
const bt = i$4(_B || (_B = __template(["main{padding:20px;padding-top:0;width:100%}"])));
var yt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let xe = class extends s$1 {
  render() {
    return x(_C || (_C = __template(["<main><slot></slot></main>"])));
  }
};
xe.styles = [h.globalCss, bt], xe = yt([e$3("wcm-modal-content")], xe);
const $t = i$4(_D || (_D = __template(["footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}"])));
var Ot = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let ye = class extends s$1 {
  render() {
    return x(_E || (_E = __template(["<footer><slot></slot></footer>"])));
  }
};
ye.styles = [h.globalCss, $t], ye = Ot([e$3("wcm-modal-footer")], ye);
const Wt = i$4(_F || (_F = __template(["header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}"])));
var It = Object.defineProperty, Et = Object.getOwnPropertyDescriptor, te = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Et(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
  return a2 && t2 && It(o3, r2, t2), t2;
};
let S2 = class extends s$1 {
  constructor() {
    super(...arguments), this.title = "", this.onAction = void 0, this.actionIcon = void 0, this.border = false;
  }
  backBtnTemplate() {
    return x(_G || (_G = __template(['<button class="wcm-back-btn" @click="', '">', "</button>"])), T$3.goBack, v.BACK_ICON);
  }
  actionBtnTemplate() {
    return x(_H || (_H = __template(['<button class="wcm-action-btn" @click="', '">', "</button>"])), this.onAction, this.actionIcon);
  }
  render() {
    const e2 = { "wcm-border": this.border }, o3 = T$3.state.history.length > 1, r2 = this.title ? x(_I || (_I = __template(['<wcm-text variant="big-bold">', "</wcm-text>"])), this.title) : x(_J || (_J = __template(["<slot></slot>"])));
    return x(_K || (_K = __template(['<header class="', '">', " ", " ", "</header>"])), o$1(e2), o3 ? this.backBtnTemplate() : null, r2, this.onAction ? this.actionBtnTemplate() : null);
  }
};
S2.styles = [h.globalCss, Wt], te([n$2()], S2.prototype, "title", 2), te([n$2()], S2.prototype, "onAction", 2), te([n$2()], S2.prototype, "actionIcon", 2), te([n$2({ type: Boolean })], S2.prototype, "border", 2), S2 = te([e$3("wcm-modal-header")], S2);
const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o3) {
  ...
  if (!r2) throw new Error("".concat(o3, " not found"));
  return r2;
}, getWalletIcon({ id: e2, image_id: o3 }) {
  const { walletImages: r2 } = y$2.state;
  return r2 != null && r2[e2] ? r2[e2] : o3 ? te$1.getWalletImageUrl(o3) : "";
}, getWalletName(e2, o3 = false) {
  return o3 && e2.length > 8 ? "".concat(e2.substring(0, 8), "..") : e2;
}, isMobileAnimation() {
  ...
  function i3(s3) {
    let $2 = "";
    t2 ? $2 = a$3.formatUniversalUrl(t2, s3, a2) : l2 && ($2 = a$3.formatNativeUrl(l2, s3, a2)), a$3.openHref($2, "_self");
  }
  o3 && i3(o3);
  ...
  const { walletImages: e2 } = y$2.state, o3 = Object.values(e2 != null ? e2 : {});
  return Object.values(o3);
}, truncate(e2, o3 = 8) {
  return e2.length <= o3 ? e2 : "".concat(e2.substring(0, 4), "...").concat(e2.substring(e2.length - 4));
}, setRecentWallet(e2) {
  try {
  ...
  o3 ? t2 ? T$3.push("MobileConnecting") : a2 ? T$3.push("WebConnecting") : T$3.push("InstallWallet") : r2 ? T$3.push("DesktopConnecting") : a2 ? T$3.push("WebConnecting") : t2 ? T$3.push("MobileQrcodeConnecting") : T$3.push("InstallWallet");
} }, Mt = i$4(_L || (_L = __template([".wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}"])));
var Lt = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, $e = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Rt(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
  return a2 && t2 && Lt(o3, r2, t2), t2;
};
let oe = class extends s$1 {
  ...
  firstUpdated() {
    this.resizeObserver = new ResizeObserver(([e2]) => {
      const o3 = "".concat(e2.contentRect.height, "px");
  ...
  viewTemplate() {
    switch (this.view) {
      case "ConnectWallet":
        return x(_M || (_M = __template(["<wcm-connect-wallet-view></wcm-connect-wallet-view>"])));
      case "DesktopConnecting":
        return x(_N || (_N = __template(["<wcm-desktop-connecting-view></wcm-desktop-connecting-view>"])));
      case "MobileConnecting":
        return x(_O || (_O = __template(["<wcm-mobile-connecting-view></wcm-mobile-connecting-view>"])));
      case "WebConnecting":
        return x(_P || (_P = __template(["<wcm-web-connecting-view></wcm-web-connecting-view>"])));
      case "MobileQrcodeConnecting":
        return x(_Q || (_Q = __template(["<wcm-mobile-qr-connecting-view></wcm-mobile-qr-connecting-view>"])));
      case "WalletExplorer":
        return x(_R || (_R = __template(["<wcm-wallet-explorer-view></wcm-wallet-explorer-view>"])));
      case "Qrcode":
        return x(_S || (_S = __template(["<wcm-qrcode-view></wcm-qrcode-view>"])));
      case "InstallWallet":
        return x(_T || (_T = __template(["<wcm-install-wallet-view></wcm-install-wallet-view>"])));
      default:
        return x(_U || (_U = __template(["<div>Not Found</div>"])));
    }
  }
  async onChangeRoute() {
  ...
  render() {
    return x(_V || (_V = __template(['<div class="wcm-router"><div class="wcm-content">', "</div></div>"])), this.viewTemplate());
  }
};
oe.styles = [h.globalCss, Mt], $e([t$2()], oe.prototype, "view", 2), $e([t$2()], oe.prototype, "prevView", 2), oe = $e([e$3("wcm-modal-router")], oe);
const At = i$4(_W || (_W = __template(["div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}"])));
var Pt = Object.defineProperty, Tt = Object.getOwnPropertyDescriptor, ze = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Tt(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let ne = class extends s$1 {
  ...
  render() {
    const { message: e2, variant: o3 } = oe$1.state, r2 = { "wcm-success": o3 === "success", "wcm-error": o3 === "error" };
    return this.open ? x(_X || (_X = __template(['<div class="', '">', " ", '<wcm-text variant="small-regular">', "</wcm-text></div>"])), o$1(r2), o3 === "success" ? v.CHECKMARK_ICON : null, o3 === "error" ? v.CROSS_ICON : null, e2) : null;
  }
};
...
function _t(e2, o3) {
  const r2 = Array.prototype.slice.call(Je.create(e2, { errorCorrectionLevel: o3 }).modules.data, 0), a2 = Math.sqrt(r2.length);
  return r2.reduce((t2, l2, i3) => (i3 % a2 === 0 ? t2.push([l2]) : t2[t2.length - 1].push(l2)) && t2, []);
}
const Dt = { generate(e2, o3, r2) {
  const a2 = "#141414", t2 = "#ffffff", l2 = [], i3 = _t(e2, "Q"), s3 = o3 / i3.length, $2 = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  $2.forEach(({ x: y2, y: u3 }) => {
    const O = (i3.length - A) * s3 * y2, b2 = (i3.length - A) * s3 * u3, E2 = 0.45;
    for (let M3 = 0; M3 < $2.length; M3 += 1) {
      const V2 = s3 * (A - M3 * 2);
      l2.push(b$1(_Y || (_Y = __template(['<rect fill="', '" height="', '" rx="', '" ry="', '" width="', '" x="', '" y="', '">'])), M3 % 2 === 0 ? a2 : t2, V2, V2 * E2, V2 * E2, V2, O + s3 * M3, b2 + s3 * M3));
    }
  });
  const f2 = Math.floor((r2 + 25) / s3), Ne = i3.length / 2 - f2 / 2, Ze = i3.length / 2 + f2 / 2 - 1, Se = [];
  i3.forEach((y2, u3) => {
    y2.forEach((O, b2) => {
      if (i3[u3][b2] && !(u3 < A && b2 < A || u3 > i3.length - (A + 1) && b2 < A || u3 < A && b2 > i3.length - (A + 1)) && !(u3 > Ne && u3 < Ze && b2 > Ne && b2 < Ze)) {
        const E2 = u3 * s3 + s3 / 2, M3 = b2 * s3 + s3 / 2;
        Se.push([E2, M3]);
      }
    });
  });
  ...
  return Se.forEach(([y2, u3]) => {
    ...
    const O = u3.filter((b2) => u3.every((E2) => !Ce(b2, E2, s3)));
    return [Number(y2), O];
  }).forEach(([y2, u3]) => {
    u3.forEach((O) => {
      l2.push(b$1(_Z || (_Z = __template(['<circle cx="', '" cy="', '" fill="', '" r="', '">'])), y2, O, a2, s3 / Ve));
    });
  }), Object.entries(J).filter(([y2, u3]) => u3.length > 1).map(([y2, u3]) => {
    const O = u3.filter((b2) => u3.some((E2) => Ce(b2, E2, s3)));
    return [Number(y2), O];
  }).map(([y2, u3]) => {
    u3.sort((b2, E2) => b2 < E2 ? -1 : 1);
    const O = [];
    for (const b2 of u3) {
      const E2 = O.find((M3) => M3.some((V2) => Ce(b2, V2, s3)));
      E2 ? E2.push(b2) : O.push([b2]);
    }
    return [y2, O.map((b2) => [b2[0], b2[b2.length - 1]])];
  }).forEach(([y2, u3]) => {
    u3.forEach(([O, b2]) => {
      l2.push(b$1(__ || (__ = __template(['<line x1="', '" x2="', '" y1="', '" y2="', '" stroke="', '" stroke-width="', '" stroke-linecap="round">'])), y2, y2, O, b2, a2, s3 / (Ve / 2)));
    });
  }), l2;
} }, Nt = i$4(_$ || (_$ = __template(["@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}"])));
...
let j = class extends s$1 {
  ...
  svgTemplate() {
    ...
    return b$1(_aa || (_aa = __template(['<svg height="', '" width="', '">', "</svg>"])), e2, e2, Dt.generate(this.uri, e2, e2 / 4));
  }
  render() {
    const e2 = { "wcm-dark": ne$1.state.themeMode === "dark" };
    return x(_ca || (_ca = __template(['<div style="', '" class="', '">', " ", "</div>"])), "width: ".concat(this.size, "px"), o$1(e2), this.walletId || this.imageUrl ? x(_ba || (_ba = __template(['<wcm-wallet-image walletId="', '" imageId="', '" imageUrl="', '"></wcm-wallet-image>'])), l(this.walletId), l(this.imageId), l(this.imageUrl)) : v.WALLET_CONNECT_ICON_COLORED, this.svgTemplate());
  }
};
j.styles = [h.globalCss, Nt], q([n$2()], j.prototype, "uri", 2), q([n$2({ type: Number })], j.prototype, "size", 2), q([n$2()], j.prototype, "imageId", 2), q([n$2()], j.prototype, "walletId", 2), q([n$2()], j.prototype, "imageUrl", 2), j = q([e$3("wcm-qrcode")], j);
const Bt = i$4(_da || (_da = __template([":host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}"])));
var Ut = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, Fe = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Ht(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let ce = class extends s$1 {
  ...
  render() {
    return x(_ea || (_ea = __template(['<input type="text" @input="', '" placeholder="Search wallets"> ', ""])), this.onChange, v.SEARCH_ICON);
  }
};
ce.styles = [h.globalCss, Bt], Fe([n$2()], ce.prototype, "onChange", 2), ce = Fe([e$3("wcm-search-input")], ce);
const zt = i$4(_fa || (_fa = __template(["@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}"])));
var qt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
let L3 = class extends s$1 {
  ...
  sublabelTemplate() {
    return this.recent ? x(_ka || (_ka = __template(['<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">RECENT</wcm-text>']))) : this.installed ? x(_la || (_la = __template(['<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">INSTALLED</wcm-text>']))) : null;
  }
  handleClick() {
    R$2.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e2;
    return x(_ma || (_ma = __template(['<button @click="', '"><div><wcm-wallet-image walletId="', '" imageId="', '"></wcm-wallet-image><wcm-text variant="xsmall-regular">', "</wcm-text>", "</div></button>"])), this.handleClick.bind(this), this.walletId, l(this.imageId), (e2 = this.label) != null ? e2 : c.getWalletName(this.name, true), this.sublabelTemplate());
  }
};
L3.styles = [h.globalCss, Gt], _([n$2()], L3.prototype, "onClick", 2), _([n$2()], L3.prototype, "name", 2), _([n$2()], L3.prototype, "walletId", 2), _([n$2()], L3.prototype, "label", 2), _([n$2()], L3.prototype, "imageId", 2), _([n$2({ type: Boolean })], L3.prototype, "installed", 2), _([n$2({ type: Boolean })], L3.prototype, "recent", 2), L3 = _([e$3("wcm-wallet-button")], L3);
const eo = i$4(_na || (_na = __template([":host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}"])));
var to = Object.defineProperty, oo = Object.getOwnPropertyDescriptor, se = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? oo(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let Q = class extends s$1 {
  ...
  render() {
    ...
    return x(_pa || (_pa = __template(["", ""])), o3.length ? x(_oa || (_oa = __template(['<div><img crossorigin="anonymous" src="', '" alt="', '"></div>'])), o3, this.id) : v.WALLET_PLACEHOLDER);
  }
};
...
var ro = Object.defineProperty, ao = Object.getOwnPropertyDescriptor, qe = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? ao(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let Ie = class extends s$1 {
  ...
  render() {
    const { recomendedWallets: e2 } = te$1.state, o3 = [...e2, ...e2], r2 = a$3.RECOMMENDED_WALLET_AMOUNT * 2;
    return x(_sa || (_sa = __template(['<wcm-modal-header title="Connect your wallet" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><div class="wcm-title">', '<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">', '</div><wcm-button-big @click="', '"><wcm-text variant="medium-regular" color="inverse">Select Wallet</wcm-text></wcm-button-big></div></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">Choose WalletConnect to see supported apps on your device</wcm-text></wcm-info-footer>'])), this.onGoToQrcode, v.QRCODE_ICON, v.MOBILE_ICON, [...Array(r2)].map((a2, t2) => {
      const l2 = o3[t2 % o3.length];
      return l2 ? x(_ra || (_ra = __template(['<wcm-wallet-image walletId="', '" imageId="', '"></wcm-wallet-image>'])), l2.id, l2.image_id) : v.WALLET_PLACEHOLDER;
    }), c.handleAndroidLinking);
  }
};
Ie.styles = [h.globalCss, co], Ie = ho([e$3("wcm-android-wallet-selection")], Ie);
const wo = i$4(_ta || (_ta = __template(["@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}"])));
var po = Object.defineProperty, go = Object.getOwnPropertyDescriptor, K = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? go(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let D = class extends s$1 {
  ...
  svgLoaderTemplate() {
    ...
    return x(_ua || (_ua = __template(['<svg viewBox="0 0 110 110" width="110" height="110"><rect id="wcm-loader" x="2" y="2" width="106" height="106" rx="', '"/><use xlink:href="#wcm-loader" stroke-dasharray="106 ', '" stroke-dashoffset="', '"></use></svg>'])), a2, t2, l2);
  }
  render() {
    const e2 = { "wcm-error": this.isError, "wcm-stale": this.isStale };
    return x(_va || (_va = __template(['<div class="', '">', '<wcm-wallet-image walletId="', '" imageId="', '"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="', '">', "</wcm-text>"])), o$1(e2), this.svgLoaderTemplate(), l(this.walletId), l(this.imageId), this.isError ? "error" : "primary", this.isError ? "Connection declined" : this.label);
  }
};
D.styles = [h.globalCss, wo], K([n$2()], D.prototype, "walletId", 2), K([n$2()], D.prototype, "imageId", 2), K([n$2({ type: Boolean })], D.prototype, "isError", 2), K([n$2({ type: Boolean })], D.prototype, "isStale", 2), K([n$2()], D.prototype, "label", 2), D = K([e$3("wcm-connector-waiting")], D);
const G = { manualWallets() {
  var e2, o3;
  const { mobileWallets: r2, desktopWallets: a2 } = y$2.state, t2 = (e2 = G.recentWallet()) == null ? void 0 : e2.id, l2 = a$3.isMobile() ? r2 : a2, i3 = l2 == null ? void 0 : l2.filter((s3) => t2 !== s3.id);
  return (o3 = a$3.isMobile() ? i3 == null ? void 0 : i3.map(({ id: s3, name: $2, links: f2 }) => ({ id: s3, name: $2, mobile: f2, links: f2 })) : i3 == null ? void 0 : i3.map(({ id: s3, name: $2, links: f2 }) => ({ id: s3, name: $2, desktop: f2, links: f2 }))) != null ? o3 : [];
}, recentWallet() {
  ...
  return G.manualWallets().map((e2) => x(_wa || (_wa = __template(['<wcm-wallet-button walletId="', '" name="', '" .onClick="', '"></wcm-wallet-button>'])), e2.id, e2.name, () => this.onConnecting(e2)));
}, recomendedWalletsTemplate(e2 = false) {
  return G.recomendedWallets(e2).map((o3) => x(_xa || (_xa = __template(['<wcm-wallet-button name="', '" walletId="', '" imageId="', '" .onClick="', '"></wcm-wallet-button>'])), o3.name, o3.id, o3.image_id, () => this.onConnecting(o3)));
}, recentWalletTemplate() {
  const e2 = G.recentWallet();
  if (e2) return x(_ya || (_ya = __template(['<wcm-wallet-button name="', '" walletId="', '" imageId="', '" .recent="', '" .onClick="', '"></wcm-wallet-button>'])), e2.name, e2.id, l(e2.image_id), true, () => this.onConnecting(e2));
} }, vo = i$4(_za || (_za = __template([".wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}"])));
var fo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Ee = class extends s$1 {
  render() {
    const { explorerExcludedWalletIds: e2, enableExplorer: o3 } = y$2.state, r2 = e2 !== "ALL" && o3, a2 = Z2.manualWalletsTemplate(), t2 = Z2.recomendedWalletsTemplate();
    let l2 = [Z2.recentWalletTemplate(), ...a2, ...t2];
    l2 = l2.filter(Boolean);
    const i3 = l2.length > 4 || r2;
    let s3 = [];
    i3 ? s3 = l2.slice(0, 3) : s3 = l2;
    const $2 = Boolean(s3.length);
    return x(_Ca || (_Ca = __template(['<wcm-modal-header .border="', '" title="Connect your wallet" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">', '<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">', '<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>', ""])), true, c.handleUriCopy, v.COPY_ICON, v.MOBILE_ICON, v.SCAN_ICON, $2 ? x(_Ba || (_Ba = __template(['<wcm-modal-footer><div class="wcm-desktop-title">', '<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">', " ", "</div></wcm-modal-footer>"])), v.DESKTOP_ICON, s3, i3 ? x(_Aa || (_Aa = __template(["<wcm-view-all-wallets-button></wcm-view-all-wallets-button>"]))) : null) : null);
  }
};
Ee.styles = [h.globalCss, vo], Ee = fo([e$3("wcm-desktop-wallet-selection")], Ee);
const xo = i$4(_Da || (_Da = __template(["div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}"])));
var Co = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Me = class extends s$1 {
  render() {
    const { termsOfServiceUrl: e2, privacyPolicyUrl: o3 } = y$2.state;
    return (e2 != null ? e2 : o3) ? x(_Ga || (_Ga = __template(['<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app\'s ', " ", " ", "</wcm-text></div>"])), e2 ? x(_Ea || (_Ea = __template(['<a href="', '" target="_blank" rel="noopener noreferrer">Terms of Service</a>'])), e2) : null, e2 && o3 ? "and" : null, o3 ? x(_Fa || (_Fa = __template(['<a href="', '" target="_blank" rel="noopener noreferrer">Privacy Policy</a>'])), o3) : null) : null;
  }
};
Me.styles = [h.globalCss, xo], Me = Co([e$3("wcm-legal-notice")], Me);
const ko = i$4(_Ha || (_Ha = __template(["div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}"])));
var Io = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Le = class extends s$1 {
  ...
  render() {
    ...
    let l2 = [Z2.recentWalletTemplate(), ...a2, ...t2];
    l2 = l2.filter(Boolean);
    const i3 = l2.length > 8 || r2;
    let s3 = [];
    i3 ? s3 = l2.slice(0, 7) : s3 = l2;
    const $2 = Boolean(s3.length);
    return x(_Ka || (_Ka = __template(['<wcm-modal-header title="Connect your wallet" .onAction="', '" .actionIcon="', '"></wcm-modal-header>', ""])), this.onQrcode, v.QRCODE_ICON, $2 ? x(_Ja || (_Ja = __template(["<wcm-modal-content><div>", " ", "</div></wcm-modal-content>"])), s3, i3 ? x(_Ia || (_Ia = __template(["<wcm-view-all-wallets-button></wcm-view-all-wallets-button>"]))) : null) : null);
  }
};
Le.styles = [h.globalCss, ko], Le = Io([e$3("wcm-mobile-wallet-selection")], Le);
const Eo = i$4(_La || (_La = __template([":host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}"])));
var Mo = Object.defineProperty, Lo = Object.getOwnPropertyDescriptor, Re = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Lo(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let ae = class extends s$1 {
  ...
  render() {
    ...
    return x(_Na || (_Na = __template(['<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="', '" @click="', '" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">', "</div></div>"])), o$1(e2), this.onCloseModal, this.open ? x(_Ma || (_Ma = __template(['<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>']))) : null);
  }
};
ae.styles = [h.globalCss, Eo], Re([t$2()], ae.prototype, "open", 2), Re([t$2()], ae.prototype, "active", 2), ae = Re([e$3("wcm-modal")], ae);
const Ro = i$4(_Oa || (_Oa = __template(["div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}"])));
var Ao = Object.defineProperty, Po = Object.getOwnPropertyDescriptor, le = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Po(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let B = class extends s$1 {
  ...
  render() {
    return x(_Ta || (_Ta = __template(["<div>", " ", " ", " ", "</div>"])), this.isRetry ? x(_Pa || (_Pa = __template(["<slot></slot>"]))) : null, this.isMobile ? x(_Qa || (_Qa = __template(['<wcm-button .onClick="', '" .iconLeft="', '" variant="outline">Mobile</wcm-button>'])), this.onMobile, v.MOBILE_ICON) : null, this.isDesktop ? x(_Ra || (_Ra = __template(['<wcm-button .onClick="', '" .iconLeft="', '" variant="outline">Desktop</wcm-button>'])), this.onDesktop, v.DESKTOP_ICON) : null, this.isWeb ? x(_Sa || (_Sa = __template(['<wcm-button .onClick="', '" .iconLeft="', '" variant="outline">Web</wcm-button>'])), this.onWeb, v.GLOBE_ICON) : null);
  }
};
B.styles = [h.globalCss, Ro], le([n$2({ type: Boolean })], B.prototype, "isMobile", 2), le([n$2({ type: Boolean })], B.prototype, "isDesktop", 2), le([n$2({ type: Boolean })], B.prototype, "isWeb", 2), le([n$2({ type: Boolean })], B.prototype, "isRetry", 2), B = le([e$3("wcm-platform-selection")], B);
const To = i$4(_Ua || (_Ua = __template(["button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}"])));
var Do = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Ae = class extends s$1 {
  ...
  render() {
    ...
    return x(_Xa || (_Xa = __template(['<button @click="', '"><div class="wcm-icons">', " ", '</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>'])), this.onClick, r2.map((a2) => {
      const t2 = c.getWalletIcon(a2);
      if (t2) return x(_Va || (_Va = __template(['<img crossorigin="anonymous" src="', '">'])), t2);
      const l2 = c.getWalletIcon({ id: a2.id });
      return l2 ? x(_Wa || (_Wa = __template(['<img crossorigin="anonymous" src="', '">'])), l2) : v.WALLET_PLACEHOLDER;
    }), [...Array(4 - r2.length)].map(() => v.WALLET_PLACEHOLDER));
  }
};
Ae.styles = [h.globalCss, To], Ae = Do([e$3("wcm-view-all-wallets-button")], Ae);
const No = i$4(_Ya || (_Ya = __template([".wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}"])));
var Zo = Object.defineProperty, So = Object.getOwnPropertyDescriptor, de = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? So(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let Y = class extends s$1 {
  ...
  render() {
    return x(_$a || (_$a = __template(['<div class="wcm-qr-container">', "</div>"])), this.uri ? x(_Za || (_Za = __template(['<wcm-qrcode size="', '" uri="', '" walletId="', '" imageId="', '"></wcm-qrcode>'])), this.overlayEl.offsetWidth, this.uri, l(this.walletId), l(this.imageId)) : x(__a || (__a = __template(["<wcm-spinner></wcm-spinner>"]))));
  }
};
...
let Pe = class extends s$1 {
  viewTemplate() {
    return a$3.isAndroid() ? x(_ab || (_ab = __template(["<wcm-android-wallet-selection></wcm-android-wallet-selection>"]))) : a$3.isMobile() ? x(_bb || (_bb = __template(["<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>"]))) : x(_cb || (_cb = __template(["<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>"])));
  }
  render() {
    return x(_db || (_db = __template(["", "<wcm-legal-notice></wcm-legal-notice>"])), this.viewTemplate());
  }
};
Pe.styles = [h.globalCss], Pe = Ho([e$3("wcm-connect-wallet-view")], Pe);
const zo = i$4(_eb || (_eb = __template(["wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}"])));
var Vo = Object.defineProperty, Fo = Object.getOwnPropertyDescriptor, Ke = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Fo(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let me = class extends s$1 {
  ...
  openDesktopApp() {
    const { walletConnectUri: e2 } = p$2.state, o3 = a$3.getWalletRouterData();
  ...
  render() {
    ...
    return x(_fb || (_fb = __template(['<wcm-modal-header title="', '" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="', '" imageId="', '" label="', '" .isError="', '"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">', '</wcm-text><wcm-platform-selection .isMobile="', '" .isWeb="', '" .isRetry="', '"><wcm-button .onClick="', '" .iconRight="', '">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>'])), e2, c.handleUriCopy, v.COPY_ICON, o3, l(r2), "Continue in ".concat(e2, "..."), this.isError, "Connection can continue loading if ".concat(e2, " is not installed on your device"), a2, t2, true, this.openDesktopApp.bind(this), v.RETRY_ICON);
  }
};
me.styles = [h.globalCss, zo], Ke([t$2()], me.prototype, "isError", 2), me = Ke([e$3("wcm-desktop-connecting-view")], me);
const qo = i$4(_gb || (_gb = __template(["wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}"])));
var Yo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Te = class extends s$1 {
  ...
  render() {
    ...
    return x(_hb || (_hb = __template(['<wcm-modal-header title="', '"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="', '" imageId="', '" label="Not Detected" .isStale="', '"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">', '</wcm-text><wcm-button .onClick="', '" .iconLeft="', '">Download</wcm-button></wcm-info-footer>'])), e2, o3, l(r2), true, "Download ".concat(e2, " to continue. If multiple browser extensions are installed, disable non ").concat(e2, " ones and try again"), () => this.onInstall(a2), v.ARROW_DOWN_ICON);
  }
};
Te.styles = [h.globalCss, qo], Te = Yo([e$3("wcm-install-wallet-view")], Te);
const Go = i$4(_ib || (_ib = __template(["wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}"])));
var Xo = Object.defineProperty, Jo = Object.getOwnPropertyDescriptor, Ye = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Jo(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let he = class extends s$1 {
  ...
  onFormatAndRedirect(e2, o3 = false) {
    ...
    if (t2 && !o3) {
      const i3 = a$3.formatNativeUrl(t2, e2, a2);
      a$3.openHref(i3, "_self");
    } else if (l2) {
      const i3 = a$3.formatUniversalUrl(l2, e2, a2);
      a$3.openHref(i3, "_self");
    }
  }
  openMobileApp(e2 = false) {
    const { walletConnectUri: o3 } = p$2.state, r2 = a$3.getWalletRouterData();
  ...
  render() {
    const { name: e2, id: o3, image_id: r2, app: a2, mobile: t2 } = a$3.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i3 = a2 == null ? void 0 : a2.ios, s3 = t2 == null ? void 0 : t2.universal;
    return x(_kb || (_kb = __template(['<wcm-modal-header title="', '"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="', '" imageId="', '" label="Tap \'Open\' to continue…" .isError="', '"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="', '" .isRetry="', '"><wcm-button .onClick="', '" .iconRight="', '">Retry</wcm-button></wcm-platform-selection>', '</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="', '" imageId="', '"></wcm-wallet-image><wcm-text>', '</wcm-text></div><wcm-button .iconRight="', '" .onClick="', '" variant="ghost">App Store</wcm-button></wcm-info-footer>'])), e2, o3, l(r2), this.isError, l$12, true, () => this.openMobileApp(false), v.RETRY_ICON, s3 ? x(_jb || (_jb = __template(['<wcm-text color="secondary" variant="small-thin">Still doesn\'t work? <span tabindex="0" @click="', '">Try this alternate link</span></wcm-text>'])), () => this.openMobileApp(true)) : null, o3, l(r2), "Get ".concat(e2), v.ARROW_RIGHT_ICON, () => this.onGoToAppStore(i3));
  }
};
he.styles = [h.globalCss, Go], Ye([t$2()], he.prototype, "isError", 2), he = Ye([e$3("wcm-mobile-connecting-view")], he);
const er = i$4(_lb || (_lb = __template(["wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}"])));
var rr = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let je = class extends s$1 {
  render() {
    ...
    return x(_mb || (_mb = __template(['<wcm-modal-header title="', '" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="', '" imageId="', '"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">', '</wcm-text><wcm-platform-selection .isDesktop="', '" .isWeb="', '"></wcm-platform-selection></wcm-info-footer>'])), e2, c.handleUriCopy, v.COPY_ICON, o3, l(r2), "Scan this QR Code with your phone's camera or inside ".concat(e2, " app"), a2, t2);
  }
};
...
let _e = class extends s$1 {
  render() {
    return x(_nb || (_nb = __template(['<wcm-modal-header title="Scan the code" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>'])), c.handleUriCopy, v.COPY_ICON);
  }
};
_e.styles = [h.globalCss], _e = ir([e$3("wcm-qrcode-view")], _e);
const nr = i$4(_ob || (_ob = __template(["wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}"])));
var cr = Object.defineProperty, sr = Object.getOwnPropertyDescriptor, ie = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? sr(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let U = class extends s$1 {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || t2 > De && a2.length < t2)) try {
      this.loading = true;
      const i3 = (e2 = p$2.state.chains) == null ? void 0 : e2.join(","), { listings: s3 } = await te$1.getWallets({ page: this.firstFetch ? 1 : l2 + 1, entries: De, search: this.search, version: 2, chains: i3 }), $2 = s3.map((f2) => c.getWalletIcon(f2));
      await Promise.all([...$2.map(async (f2) => c.preloadImage(f2)), a$3.wait(300)]), this.endReached = this.isLastPage();
    } catch (i3) {
      console.error(i3), oe$1.openToast(c.getErrorMessage(i3), "error");
    } finally {
  ...
  render() {
    const { wallets: e2, search: o3 } = te$1.state, { listings: r2 } = this.search ? o3 : e2, a2 = this.loading && !r2.length, t2 = this.search.length >= 3;
    let l2 = Z2.manualWalletsTemplate(), i3 = Z2.recomendedWalletsTemplate(true);
    t2 && (l2 = l2.filter(({ values: f2 }) => c.caseSafeIncludes(f2[0], this.search)), i3 = i3.filter(({ values: f2 }) => c.caseSafeIncludes(f2[0], this.search)));
    const s3 = !this.loading && !r2.length && !i3.length, $2 = { "wcm-loading": a2, "wcm-end-reached": this.endReached || !this.loading, "wcm-empty": s3 };
    return x(_tb || (_tb = __template(['<wcm-modal-header><wcm-search-input .onChange="', '"></wcm-search-input></wcm-modal-header><wcm-modal-content class="', '"><div class="wcm-grid">', " ", " ", '</div><div class="wcm-placeholder-block">', " ", "</div></wcm-modal-content>"])), this.onSearchChange.bind(this), o$1($2), a2 ? null : l2, a2 ? null : i3, a2 ? null : r2.map((f2) => x(_qb || (_qb = __template(["", ""])), f2 ? x(_pb || (_pb = __template(['<wcm-wallet-button imageId="', '" name="', '" walletId="', '" .onClick="', '"></wcm-wallet-button>'])), f2.image_id, f2.name, f2.id, () => this.onConnect(f2)) : null)), s3 ? x(_rb || (_rb = __template(['<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>']))) : null, !s3 && this.loading ? x(_sb || (_sb = __template(["<wcm-spinner></wcm-spinner>"]))) : null);
  }
};
...
const dr = i$4(_ub || (_ub = __template(["wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}"])));
var mr = Object.defineProperty, hr = Object.getOwnPropertyDescriptor, Ge = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? hr(o3, r2) : o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = (a2 ? i3(o3, r2, t2) : i3(t2)) || t2);
...
let we = class extends s$1 {
  ...
  render() {
    ...
    return x(_vb || (_vb = __template(['<wcm-modal-header title="', '" .onAction="', '" .actionIcon="', '"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="', '" imageId="', '" label="', '" .isError="', '"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">', '</wcm-text><wcm-platform-selection .isMobile="', '" .isDesktop="', '" .isRetry="', '"><wcm-button .onClick="', '" .iconRight="', '">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>'])), e2, c.handleUriCopy, v.COPY_ICON, o3, l(r2), "Continue in ".concat(e2, "..."), this.isError, "".concat(e2, " web app has opened in a new tab. Go there, accept the connection, and come back"), a2, l$12 ? false : t2, true, this.openWebWallet.bind(this), v.RETRY_ICON);
  }
};
